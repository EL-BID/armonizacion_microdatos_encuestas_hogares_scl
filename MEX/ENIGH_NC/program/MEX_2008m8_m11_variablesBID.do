...
*afiliado_ci****
****************
destring pres_* servmed_* inscr_* inscr_* inst_* atemed tam_emp1  contrato1, replace
gen afiliado_ci=0     if condocup_ci==1 | condocup_ci==2 /*se pregunta todas las personas pero me quedo con la pea*/	
replace afiliado_ci=1 if (pres_81==8) | (inscr_1 == 1  & (servmed_3==3 | servmed_5==5 | servmed_6==6 | servmed_7==7)) 
...
*lp1_ci***
*********
generat lp1_ci =949.38 if zona_c==1
replace lp1_ci =706.69  if zona_c==0
label var lp1_ci "linea de pobreza alimentaria"
...
*lp3_ci***
*********
generat lp3_ci =1904.84 if zona_c==1
replace lp3_ci =1282.34 if zona_c==0
label var lp3_ci "linea de pobreza de patrimonio"
...
*	horastot_ci
******************************
replace htrab2=0 if otro_trab1!=1 | otro_trab2!=1
gen horastot_ci=htrab1+htrab2 if emp_ci==1 &  (htrab1+htrab2<148)
...
replace categosec_ci=2 if indep2==2
...
replace contrato_ci=1 if contrato1==1 & emp_ci==1
replace contrato_ci=0 if contrato1==2 & emp_ci==1
...
replace segsoc_ci=1 if (pres_91==9 )
*/
...
******************************
gen nempleos_ci=.
replace nempleos_ci=1 if otro_trab1==2 & emp_ci ==1
replace nempleos_ci=2 if otro_trab1==1 & emp_ci ==1
...
tostring cmo1, replace
gen ocupa=real(substr(cmo1,1,2))
gen ocupa_ci=.
...
******************************
gen autocons_ci=autocons/nmiembros
gen autocons_ch=autocons
******************************
*	rentaimp_ch 
******************************
...
*no asisten
gen n_instr142n=n_instr162
replace aedu_ci=0 		if n_instr161==0 | n_instr161==1 
replace aedu_ci=n_instr142n 	if n_instr161==2  
replace aedu_ci=n_instr142n+6 	if n_instr161==3 
replace aedu_ci=n_instr142n+9 	if n_instr161==4  
replace aedu_ci=n_instr142n+12 	if n_instr161==5 
replace aedu_ci=n_instr142n+17 	if n_instr161==8 | n_instr161==9 
replace aedu_ci=n_instr142n+12 	if n_instr161==7
replace aedu_ci=n_instr142n+12 	if n_instr161==6
...
*	edupre_ci
******************************
gen edupre_ci=(nivel==1 | n_instr161==1) 
replace edupre_ci=. if aedu_ci==.
label var edupre_ci "Educación preescolar"
...
replace edupub_ci=2 if tipoesc==2 | tipoesc==3
label var edupub_ci "Personas que asisten a centros de ensenanza publicos"

***************
***tecnica_ci *
***************
gen tecnica_ci=(nivel==6 | n_instr162 ==6)
...
replace aguadist_ch= 3 if agua13 ==4 | agua13 ==6
...
*	vivialq_ch
******************************
gen vivialq_ch= gas_trig003/3
label var vivialq_ch "alquiler mensual"
******************************
*	vivialqimp_ch
******************************
gen vivialqimp_ch=esti/3
...
*********
/*gen raza_ci=.
replace raza_ci=1 if(lengua6==1)
...
gen raza_idioma_ci=.
replace raza_idioma_ci=1 if lengua6==1
bys idh_ch: gen aux=raza_idioma_ci if parentesco==101
bys idh_ch: egen aux1 = max(aux)
replace raza_idioma_ci=aux1 if (raza_idioma_ci ==. & (parentesco==301|parentesco==304| ///
