		***********************************************************
		***PROGRAMA PARA PEGAR LOS MÓDULOS DE LA ENFT OCTUB 2009***
		***********************************************************
...
use "`base_in'\Vivienda O2009.dta", clear
sort eft_vivienda 
save, replace

use "`base_in'\Hogar O2009.dta", clear
sort eft_vivienda eft_hogar 
save, replace

use "`base_in'\ingexterior O2009.dta", clear
sort eft_vivienda eft_hogar eft_miembro
save, replace

use "`base_in'\remesas O2009.dta", clear
sort eft_vivienda eft_hogar eft_miembro
save, replace

use "`base_in'\calculadas O2009.dta", clear
sort eft_vivienda eft_hogar eft_miembro
save, replace


use "`base_in'\ocupacion O2009.dta", clear
sort eft_vivienda eft_hogar eft_miembro
save, replace


use "`base_in'\miembro O2009.dta", clear
sort eft_vivienda eft_hogar eft_miembro
save, replace
...
merge eft_vivienda eft_hogar eft_miembro using "`base_in'\ocupacion O2009.dta"
tab _merge
...
merge eft_vivienda eft_hogar eft_miembro using "`base_in'\calculadas O2009.dta"
tab _merge
drop _merge
sort eft_vivienda eft_hogar eft_miembro

merge eft_vivienda eft_hogar eft_miembro using "`base_in'\remesas O2009.dta"
tab _merge
tab eft_edad if _merge==1
drop _merge
sort eft_vivienda eft_hogar eft_miembro

merge eft_vivienda eft_hogar eft_miembro using "`base_in'\ingexterior O2009.dta"
tab _merge
drop _merge
sort eft_vivienda

merge eft_vivienda using "`base_in'\Vivienda O2009.dta"
tab _merge
drop _merge
sort eft_vivienda eft_hogar 

merge eft_vivienda eft_hogar  using "`base_in'\Hogar O2009.dta"
tab _merge
drop _merge
