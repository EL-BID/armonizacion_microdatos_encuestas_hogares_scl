...
use "`base_in'\hog132.dta", clear
sort entidad control linea serie num_hog 
egen id = group(entidad control linea serie num_hog)
duplicates report id
g pesoh = peso
saveold "`base_in'\hog132_.dta", replace
  
use "`base_in'\per132.dta", clear
sort entidad control linea serie num_hog 
egen id = group(entidad control linea serie num_hog)
duplicates report id
g pesop = peso
saveold "`base_in'\per132_.dta", replace 
  
use "`base_in'\viv132.dta", clear
sort entidad control linea serie 
duplicates report entidad control linea serie 
g pesov = peso
drop peso
saveold "`base_in'\viv132_.dta", replace 


use "`base_in'\viv132_.dta"  
merge 1:m entidad control linea serie using "`base_in'\hog132_.dta"
drop _merge
merge 1:m id using "`base_in'\per132_.dta"
