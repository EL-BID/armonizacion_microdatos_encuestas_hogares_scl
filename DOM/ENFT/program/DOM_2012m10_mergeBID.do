...
sort eft_vivienda 
save "`base_in'\Vivienda O2012.dta", replace

clear
use "`base_in'\hogar.dta"
foreach v of varlist _all {
local lowname = lower("`v'")
rename `v' `lowname'
}
...
save "`base_in'\Hogar O2012.dta", replace

clear
use "`base_in'\ingexterior.dta"
foreach v of varlist _all {
local lowname = lower("`v'")
rename `v' `lowname'
}
...
save "`base_in'\ingexterior O2012.dta", replace

clear
use "`base_in'\remesas.dta"
foreach v of varlist _all {
local lowname = lower("`v'")
rename `v' `lowname'
}
...
sort eft_vivienda eft_hogar eft_miembro
save "`base_in'\remesas O2012.dta", replace

clear
use "`base_in'\calculadas.dta"
foreach v of varlist _all {
local lowname = lower("`v'")
rename `v' `lowname'
}
...
sort eft_vivienda eft_hogar eft_miembro
save "`base_in'\calculadas O2012.dta", replace

clear
use "`base_in'\ocupacion.dta"
foreach v of varlist _all {
local lowname = lower("`v'")
rename `v' `lowname'
}
...
sort eft_vivienda eft_hogar eft_miembro
save "`base_in'\ocupacion O2012.dta", replace

clear
use "`base_in'\miembros.dta"
foreach v of varlist _all {
local lowname = lower("`v'")
rename `v' `lowname'
}
...
merge eft_vivienda eft_hogar eft_miembro using "`base_in'\calculadas O2012.dta"
tab _merge
drop _merge
sort eft_vivienda eft_hogar eft_miembro

merge eft_vivienda eft_hogar eft_miembro using "`base_in'\remesas O2012.dta"
tab _merge
tab eft_edad if _merge==1
drop _merge
sort eft_vivienda eft_hogar eft_miembro

merge eft_vivienda eft_hogar eft_miembro using "`base_in'\ingexterior O2012.dta"
tab _merge
drop _merge
sort eft_vivienda

merge eft_vivienda using "`base_in'\Vivienda O2012.dta"
tab _merge
drop _merge
sort eft_vivienda eft_hogar 

merge eft_vivienda eft_hogar  using "`base_in'\Hogar O2012.dta"
tab _merge
drop _merge
