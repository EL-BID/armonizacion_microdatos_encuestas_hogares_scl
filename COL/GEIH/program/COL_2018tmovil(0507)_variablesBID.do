...
Siguiente version: Daniela Zuluaga (danielazu@iadb.org)
Fecha modificaciÃ³n: Marzo 2019
...
*****************
	...
	la var nmayor21_ch "Número de familiares mayores a 21 aÃ±os"

*****************
***nmenor21_ch***
*****************
	bys idh_ch: egen nmenor21_ch = sum((relacion_ci> = 1 & relacion_ci< = 4) & edad_ci < 21)
	la var nmenor21_ch "Número de familiares menores a 21 aÃ±os"

*****************
***nmayor65_ch***
*****************
	bys idh_ch: egen nmayor65_ch = sum((relacion_ci >= 1 & relacion_ci <= 4) & edad_ci >= 65 & edad_ci!=.)
	la var nmayor65_ch "Número de familiares mayores a 65 aÃ±os"

****************
***nmenor6_ch***
****************
	bys idh_ch: egen nmenor6_ch = sum((relacion_ci >= 1 & relacion_ci <= 4) & edad_ci < 6)
	la var nmenor6_ch "Número de familiares menores a 6 aÃ±os"

****************
***nmenor1_ch***
****************
	bys idh_ch: egen nmenor1_ch = sum((relacion_ci >= 1 & relacion_ci <= 4) & edad_ci < 1)
	la var nmenor1_ch "Número de familiares menores a 1 aÃ±o"
...
******************
	g repiteult_ci = .
	la var repiteult "Ha repetido el íltimo grado"
...
************
	...
	la var luz_ch  "La principal fuente de iluminaciín es electricidad"
...
**************
	...
	la var resid_ch "MÃ©todo de eliminación de residuos"
