...
replace mes_c= 12 if sema_levan>=19 & sema_levan<=23
*** average week of the survey is 11.09
replace mes_c= 10 if mes_c==.
label variable mes_c "Mes de la Encuesta: Segundo Semestre de 1999"
...
gen tamemp_ci=1 if pp45==1 
label var  tamemp_ci "Tamaño de Empresa" 
*Empresas medianas
replace tamemp_ci=2 if pp45==2 | pp45==3
*Empresas grandes
replace tamemp_ci=3 if pp45==4 
...
*********
gen lp_ci=.
replace lp_ci=53638.2 if zona_c==1
replace lp_ci=42910.6 if zona_c==0
...
gen salmm_ci=.
replace salmm_ci=120000/1000 if zona_c==1 /*en Bs*/
replace salmm_ci=108000/1000 if zona_c==0 
...
/*gen durades_ci=pp41a if pp41a>=0 & desemp_ci==1
replace durades_ci=pp41b*12 if pp41b>=0 & desemp_ci==1
*/
...
replace desalent_ci=1 if (pp29>4 & pp29<10) & pp30==11 & pp31==2 & pp36==2 & (p39==1 | p39==2 )
...
replace tamfirma_ci=1 if emp==1 & (pp45>=2 & pp45<=4)
replace tamfirma_ci=0 if emp==1 & pp45==1
