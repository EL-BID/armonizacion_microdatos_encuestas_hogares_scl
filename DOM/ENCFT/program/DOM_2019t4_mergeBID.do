...
PaÃ­s: Republica Dominicana
Encuesta: ENCFT
Round: m10
Autores: Mayra Saenz mayras@iadb.org
Fecha última modificación:23 julio 2020 by Angela Lopez/ alop@iadb.org
...
import excel "`base_in'\Base ENCFT 20181 - 20194.xlsx", sheet("`mod'") firstrow case(lower) clear
keep if trimestre == 20194 
...
*DZ Dic 2019: Se filtra y se deja unicamente información para cuarto trimestre*
