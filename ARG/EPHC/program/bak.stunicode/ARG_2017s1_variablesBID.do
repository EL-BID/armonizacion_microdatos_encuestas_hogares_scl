...
۬tima version Stephanie González (SCL/SCL) - Email: stephaniego@iadb.org
...
*SGR: En la versión 2017 no está en string la variable.
...
replace aedu_ci=18 	if aedu_ci==. & eduuc_ci==1
	...
	**********
	...
	gen techo_ch=0 if iv4==5 | iv4==6 | iv4==7
	replace techo_ch=1  if iv4==1 | iv4==2 | iv4==3 | iv4==4
...
/* https://www.indec.gob.ar/uploads/informesdeprensa/eph_pobreza_01_17.pdf página 10. 
calculo: Canasta Básica Total promedio del hogar pobre/Tamaño promedio del hogar pobre en adulto equivalente,
