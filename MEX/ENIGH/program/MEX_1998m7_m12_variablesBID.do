...
*lpe_ci***
*********
generat lpe_ci =524.45 if zona_c==1
replace lpe_ci =388.13  if zona_c==0
label var lpe_ci "linea de pobreza alimentaria oficial del pais"

*********
*lp2_ci***
*********
generat lp2_ci =643.24 if zona_c==1
replace lp2_ci =458.89  if zona_c==0
label var lp2_ci "linea de pobreza de capacidades"

*********
*lp_ci***
*********
generat lp_ci =1052.25 if zona_c==1
replace lp_ci =704.31 if zona_c==0
label var lp_ci "linea de pobreza de patrimonio oficial del pais"

*************
**salmm_ci***
*************
/*La encuesta fue levantada entre los meses de julio y diciembre 1998,
y por tanto, al preguntarse por los ingresos de los ultimos seis meses, 
se recolecto informacion correspondiente a enero-junio, febrero-julio, 
marzo-agosto, abril-septiembre, mayo-octubre y junio-noviembre 1998 
*/
...
generat salmm_ci=30.20*30 if zona_salmm==1 
replace salmm_ci=28.00*30 if zona_salmm==2 
replace salmm_ci=26.05*30 if zona_salmm==3 
...
replace desemp3_ci=0 if causa>0 & causa<=10
replace desemp3_ci=1 if causa==6

/* la definicion no incluye desempeados de solo una semana*/
*************
***pea1_ci***
*************
gen pea1_ci=0
...
destring n_empleo numper,replace
gen nempleos_ci=0
...
replace rama_ci=1 if rama=="9710"
replace rama_ci=5 if rama=="9720"
replace rama_ci=6 if rama=="9750"|rama=="9310"|rama=="9320"
replace rama_ci=7 if (rama=="9790"|rama=="9731"|rama=="9732"|rama=="9733")
replace rama_ci=8 if (rama=="9510"|rama=="9740")
replace rama_ci=. if emp_ci~=1
replace rama_ci=. if rama_ci==0
*/
/*
* Con esta clasificacion la serie del anio no tiene saltos MG ( en revision)
gen rama_ci=real(substr(rama,1,1))
replace rama_ci=. if emp_ci~=1
replace rama_ci=. if rama_ci==0
*/
