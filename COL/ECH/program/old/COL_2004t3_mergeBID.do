...
*** VIVIENDA ***
clear
infix TIPO 1-2 SEGMENTO 8-10 REGION 11-11 SECTOR 12-15 SECCION 16-17 MANZANA 18-19 EDIFICACION 20-22 VIVIENDA 23-25 ///
TOTAL_HOGARES 26-27 HOGAR 28-29 TAMANO 30-31 RESULTADO 32-32  DPTO 3-4  MPIO 5-7 FACTOR 172-176 V1 33-33 V2 34-34 V3 35-35 V4A 36-36 ///
V4A_ESTRATO 37-37 V4B 38-38 V4C 39-39 V4D 40-40 V5 41-41 VA1 42-43 VA2 44-45 ///
VA3 46-46 VA4 47-47 VA5 48-48 VA6 49-49 VA7 50-50 VA8 51-51 VA9 52-61 ///
VA10A 62-62 VA10B 63-63 VA10C 64-64 VA10D 65-65 VA10E 66-66 VA10F 67-67 VA10G 68-68 VA10H 69-69 VA10I 70-70 VA10J 71-71 ///
VA10K 72-72 VA10L 73-73 using `m`i''CAB040`i'.TXT 
gen ANO = 2004
gen MES = `i'
keep if TIPO==01
...
clear
infix TIPO 1-2 SEGMENTO 8-10 REGION 11-11 SECTOR 12-15 SECCION 16-17 MANZANA 18-19 EDIFICACION 20-22 VIVIENDA 23-25 ///
TOTAL_HOGARES 26-27 HOGAR 28-29 TAMANO 30-31 RESULTADO 32-32 DPTO 3-4  MPIO 5-7  FACTOR 172-176 ORDEN 33-34 C3 35-36 C4 37-37 C5 38-39 ///
C6 40-40 C7 41-41 C8 42-42 C9 43-43 C10 44-46 using `m`i''CAB040`i'.TXT 
gen ANO = 2004
gen MES = `i'
keep if TIPO==10
...
clear
infix TIPO 1-2 SEGMENTO 8-10 REGION 11-11 SECTOR 12-15 SECCION 16-17 MANZANA 18-19 EDIFICACION 20-22 VIVIENDA 23-25 ///
TOTAL_HOGARES 26-27 HOGAR 28-29 TAMANO 30-31 RESULTADO 32-32 DPTO 3-4  MPIO 5-7  FACTOR 172-176 ORDEN 33-34 ORDEN2 35-36 F12 37-37 F13 38-38 ///
F14 39-39 F15 40-40 F15A 41-41 F15B 42-42 F15C 43-44 F16 45-45 F17 46-46 F18 47-48 F19 49-49 F20 50-50 F21 51-51 ///
F22 52-53 F23 54-54 using `m`i''CAB040`i'.TXT 
gen ANO = 2004
gen MES = `i'
keep if TIPO==50
egen llave =concat(DPTO MPIO SEGMENTO REGION SECTOR SECCION MANZANA EDIFICACION VIVIENDA TOTAL_HOGARES HOGAR  TAMANO FACTOR ORDEN)
...
clear
infix TIPO 1-2 SEGMENTO 8-10 REGION 11-11 SECTOR 12-15 SECCION 16-17 MANZANA 18-19 EDIFICACION 20-22 VIVIENDA 23-25 ///
TOTAL_HOGARES 26-27 HOGAR 28-29 TAMANO 30-31 RESULTADO 32-32 DPTO 3-4  MPIO 5-7  FACTOR 172-176 ORDEN 33-34 O24 35-36 O26 37-38 O27 41-41 ///
O28 42-51 O29 52-52 O29_VALOR 53-62 O30 63-63 O30_VALOR 64-73 O30A 74-74 O30A_VALOR 75-84 O30B 85-85 O30B_VALOR 86-95 ///
O31 96-105 O32A 106-115 O32B 116-125 O33A 126-135 O33B 136-145 O33C 146-155 using `m`i''CAB040`i'.TXT 
gen ANO = 2004
gen MES = `i'
keep if TIPO==60 
egen llave =concat(DPTO MPIO SEGMENTO REGION SECTOR SECCION MANZANA EDIFICACION VIVIENDA TOTAL_HOGARES HOGAR  TAMANO FACTOR ORDEN)
...
clear
infix TIPO 1-2 SEGMENTO 8-10 REGION 11-11 SECTOR 12-15 SECCION 16-17 MANZANA 18-19 EDIFICACION 20-22 VIVIENDA 23-25 ///
TOTAL_HOGARES 26-27 HOGAR 28-29 TAMANO 30-31 RESULTADO 32-32 DPTO 3-4  MPIO 5-7  FACTOR 172-176 ORDEN 33-34 O34 35-37 O35A 38-38 O35B 39-41 ///
O36A 42-42 O36B 43-44 using `m`i''CAB040`i'.TXT 
gen ANO = 2004
gen MES = `i'
keep if TIPO==61
egen llave =concat(DPTO MPIO SEGMENTO REGION SECTOR SECCION MANZANA EDIFICACION VIVIENDA TOTAL_HOGARES HOGAR  TAMANO FACTOR ORDEN)
...
clear
infix TIPO 1-2 SEGMENTO 8-10 REGION 11-11 SECTOR 12-15 SECCION 16-17 MANZANA 18-19 EDIFICACION 20-22 VIVIENDA 23-25 ///
TOTAL_HOGARES 26-27 HOGAR 28-29 TAMANO 30-31 RESULTADO 32-32 DPTO 3-4  MPIO 5-7  FACTOR 172-176 ORDEN 33-34 O37 35-35 O38 36-45 O39 46-47 ///
O40 52-52 O41 53-54 O42 55-55 O43 56-56 O44 57-57 O45 58-58 O46A 59-59 O46B 60-60 O46C 61-61 O46D 62-62 O46E 63-63 ///
O46F 64-64 O46G 65-65 O46H 66-66 O46I 67-67 O47 68-68 O48 69-69 using `m`i''CAB040`i'.TXT 
gen ANO = 2004
gen MES = `i'
keep if TIPO==62
egen llave =concat(DPTO MPIO SEGMENTO REGION SECTOR SECCION MANZANA EDIFICACION VIVIENDA TOTAL_HOGARES HOGAR  TAMANO FACTOR ORDEN)
...
clear 
infix TIPO 1-2 SEGMENTO 8-10 REGION 11-11 SECTOR 12-15 SECCION 16-17 MANZANA 18-19 EDIFICACION 20-22 VIVIENDA 23-25 ///
TOTAL_HOGARES 26-27 HOGAR 28-29 TAMANO 30-31 RESULTADO 32-32 DPTO 3-4  MPIO 5-7  FACTOR 172-176 ORDEN 33-34 D49 35-37 D50 38-40 D51 41-42 ///
D52 43-43 D53 44-44 D54 45-47 D55 48-49 D56 50-51 D57 54-54 D58A 55-64 D58B 65-74 D58C 75-84 D59A 85-94 D59B 95-104 ///
D59C 105-114 using `m`i''CAB040`i'.TXT 
gen ANO = 2004
gen MES = `i'
keep if TIPO==70 
egen llave =concat(DPTO MPIO SEGMENTO REGION SECTOR SECCION MANZANA EDIFICACION VIVIENDA TOTAL_HOGARES HOGAR  TAMANO FACTOR ORDEN)
...
clear 
infix TIPO 1-2 SEGMENTO 8-10 REGION 11-11 SECTOR 12-15 SECCION 16-17 MANZANA 18-19 EDIFICACION 20-22 VIVIENDA 23-25 ///
TOTAL_HOGARES 26-27 HOGAR 28-29 TAMANO 30-31 RESULTADO 32-32 DPTO 3-4  MPIO 5-7  FACTOR 172-176 ORDEN 33-34 I60 35-35 I61 36-36 I62 37-37 ///
I63 38-38 I64 39-39 I65A 40-49 I65B 50-59 I65C 60-69 I66A 70-79 I66B 80-89 I66C 90-99 using `m`i''CAB040`i'.TXT 
gen ANO = 2004
gen MES = `i'
keep if TIPO==80 
egen llave =concat(DPTO MPIO SEGMENTO REGION SECTOR SECCION MANZANA EDIFICACION VIVIENDA TOTAL_HOGARES HOGAR  TAMANO FACTOR ORDEN)
...
*** VIVIENDA ***
clear
infix TIPO 1-2 DPTO 3-4  MPIO 5-7 SEGMENTO 8-10 REGION 11-11 MANZANA 18-19 EDIFICACION 20-22 VIVIENDA 23-25 TOTAL_HOGARES 26-27 ///
HOGAR 28-29 TAMANO 30-31 RESULTADO 32-32 FACTOR 172-176 V1 33-33 V2 34-34 V3 35-35 V4A 36-36 V4A_ESTRATO 37-37 ///
V4B 38-38 V4C 39-39 V4D 40-40 V5 41-41 VA1 42-43 VA2 44-45 VA3 46-46 VA4 47-47 VA5 48-48 VA6 49-49 VA7 50-50 ///
VA8 51-51 VA9 52-61 VA10A 62-62 VA10B 63-63 VA10C 64-64 VA10D 65-65 VA10E 66-66 VA10F 67-67 VA10G 68-68 VA10H 69-69 ///
VA10I 70-70 VA10J 71-71 VA10K 72-72 VA10L 73-73 using `m`i''RES040`i'.TXT 
gen ANO = 2004
gen MES = `i'
keep if TIPO==01
...
clear
infix TIPO 1-2 DPTO 3-4  MPIO 5-7 SEGMENTO 8-10 REGION 11-11 MANZANA 18-19 EDIFICACION 20-22 VIVIENDA 23-25 TOTAL_HOGARES 26-27 ///
HOGAR 28-29 TAMANO 30-31 RESULTADO 32-32 FACTOR 172-176 ORDEN 33-34 C3 35-36 C4 37-37 C5 38-39 C6 40-40 ///
C7 41-41 C8 42-42 C9 43-43 C10 44-46 using `m`i''RES040`i'.TXT 
gen ANO = 2004
gen MES = `i'
keep if TIPO==10
...
clear
infix TIPO 1-2 DPTO 3-4  MPIO 5-7 SEGMENTO 8-10 REGION 11-11 MANZANA 18-19 EDIFICACION 20-22 VIVIENDA 23-25 TOTAL_HOGARES 26-27 ///
HOGAR 28-29 TAMANO 30-31 RESULTADO 32-32 FACTOR 172-176 ORDEN 33-34 ORDEN2 35-36 F12 37-37 F13 38-38 F14 39-39 ///
F15 40-40 F15A 41-41 F15B 42-42 F15C 43-44 F16 45-45 F17 46-46 F18 47-48 F19 49-49 F20 50-50 F21 51-51 ///
F22 52-53 F23 54-54 using `m`i''RES040`i'.TXT 
gen ANO = 2004
gen MES = `i'
keep if TIPO==50
egen llave = concat(DPTO MPIO SEGMENTO REGION  MANZANA EDIFICACION VIVIENDA TOTAL_HOGARES HOGAR TAMANO FACTOR ORDEN)
...
clear
infix TIPO 1-2 DPTO 3-4  MPIO 5-7 SEGMENTO 8-10 REGION 11-11 MANZANA 18-19 EDIFICACION 20-22 VIVIENDA 23-25 TOTAL_HOGARES 26-27 ///
HOGAR 28-29 TAMANO 30-31 RESULTADO 32-32 FACTOR 172-176 ORDEN 33-34 O24 35-36 O26 37-38 O27 41-41 O28 42-51 ///
O29 52-52 O29_VALOR 53-62 O30 63-63 O30_VALOR 64-73 O30A 74-74 O30A_VALOR 75-84 O30B 85-85 O30B_VALOR 86-95 ///
O31 96-105 O31A 106-115 O32A 116-125 O32B 126-135 O33A 136-145 O33B 146-155 O33C 156-165 using `m`i''RES040`i'.TXT 
gen ANO = 2004
gen MES = `i'
keep if TIPO==60 
egen llave = concat(DPTO MPIO SEGMENTO REGION  MANZANA EDIFICACION VIVIENDA TOTAL_HOGARES HOGAR TAMANO FACTOR ORDEN)
...
clear
infix TIPO 1-2 DPTO 3-4  MPIO 5-7 SEGMENTO 8-10 REGION 11-11 MANZANA 18-19 EDIFICACION 20-22 VIVIENDA 23-25 TOTAL_HOGARES 26-27 ///
HOGAR 28-29 TAMANO 30-31 RESULTADO 32-32 FACTOR 172-176 ORDEN 33-34 O34 35-37 O35A 38-38 O35B 39-41 O36A 42-42 ///
O36B 43-44 using `m`i''RES040`i'.TXT 
gen ANO = 2004
gen MES = `i'
keep if TIPO==61
egen llave = concat(DPTO MPIO SEGMENTO REGION  MANZANA EDIFICACION VIVIENDA TOTAL_HOGARES HOGAR TAMANO FACTOR ORDEN)
...
clear
infix TIPO 1-2 DPTO 3-4  MPIO 5-7 SEGMENTO 8-10 REGION 11-11 MANZANA 18-19 EDIFICACION 20-22 VIVIENDA 23-25 TOTAL_HOGARES 26-27 ///
HOGAR 28-29 TAMANO 30-31 RESULTADO 32-32 FACTOR 172-176 ORDEN 33-34 O37 35-35 O38 36-45 O39 46-47 O40 52-52 ///
O41 53-54 O42 55-55 O43 56-56 O44 57-57 O45 58-58 O46A 59-59 O46B 60-60 O46C 61-61 O46D 62-62 O46E 63-63 O46F 64-64 ///
O46G 65-65 O46H 66-66 O46I 67-67 O46J 68-68 O47 69-69 O48 70-70 using `m`i''RES040`i'.TXT 
gen ANO = 2004
gen MES = `i'
keep if TIPO==62
egen llave = concat(DPTO MPIO SEGMENTO REGION  MANZANA EDIFICACION VIVIENDA TOTAL_HOGARES HOGAR TAMANO FACTOR ORDEN)
...
clear 
infix TIPO 1-2 DPTO 3-4  MPIO 5-7 SEGMENTO 8-10 REGION 11-11 MANZANA 18-19 EDIFICACION 20-22 VIVIENDA 23-25 TOTAL_HOGARES 26-27 ///
HOGAR 28-29 TAMANO 30-31 RESULTADO 32-32 FACTOR 172-176 ORDEN 33-34 D49 35-37 D50 38-40 D51 41-42 D52 43-43 ///
D53 44-44 D54 45-47 D55 48-49 D56 50-51 D57 54-54 D58A 55-64 D58B 65-74 D58C 75-84 D59A 85-94 D59B 95-104 ///
D59C 105-114 using `m`i''RES040`i'.TXT 
gen ANO = 2004
gen MES = `i'
keep if TIPO==70 
egen llave = concat(DPTO MPIO SEGMENTO REGION  MANZANA EDIFICACION VIVIENDA TOTAL_HOGARES HOGAR TAMANO FACTOR ORDEN)
...
clear 
infix TIPO 1-2 DPTO 3-4  MPIO 5-7 SEGMENTO 8-10 REGION 11-11 MANZANA 18-19 EDIFICACION 20-22 VIVIENDA 23-25 TOTAL_HOGARES 26-27 ///
HOGAR 28-29 TAMANO 30-31 RESULTADO 32-32 FACTOR 172-176 ORDEN 33-34 I60 35-35 I61 36-36 I62 37-37 I63 38-38 ///
I64 39-39 I65A 40-49 I65B 50-59 I65C 60-69 I66A 70-79 I66B 80-89 I66C 90-99 using `m`i''RES040`i'.TXT 
gen ANO = 2004
gen MES = `i'
keep if TIPO==80 
egen llave = concat(DPTO MPIO SEGMENTO REGION  MANZANA EDIFICACION VIVIENDA TOTAL_HOGARES HOGAR TAMANO FACTOR ORDEN)
...
label var V5 "5. żEL AGUA LLEGA LAS 24 HOR"
...
label var C7 "7. żSABE  LEER Y ESCRIBIR?"
label var C8 "8. żACTUALMENTE....ESTUDIA?"
...
label var F12 "12. żEN QUE ACTIVIDAD OCUPO...LA MAYOR PARTE DEL TIEMPO LA SEMANA  PASADA?"
...
label var F16 "16.  żEN LAS ULTIMAS 4 SEMANAS.....HIZO ALGUNA DILIGENCIA PARA CONSE.."
label var F17 "17.  .... DESEA CONSEGUIR UN  TRABAJO REMUNERADO O INSTALAR UN NEGOCIO "
label var F18 "18.  AUNQUE... DESEA TRABAJAR    żPOR QUÉ MOTIVO PRINCIPAL  NO HIZO DILIGENCIAS EN LA  ULTIMAS 4 SEMANAS?"
label var F19 "19. DURANTE LOS ULTIMOS 12  MESES ż..TRABAJO POR LO MENOS 2 SEMANAS ....."
label var F20 "20. DESPUÉS DE SU ULTIMO  EMPLEO żHA HECHO ALGUNA DILIGENCIA PARA CONSEGUI"
label var F21 "21. DURANTE LOS ULTIMOS 12 MESES żHA HECHO ALGUNA DILIGENCIA PARA TRABAJAR"
label var F22 "22.  CUANTOS MESES HACE QUE.. DEJO DE BUSCAR TRABAJO  POR ULTIMA VEZ"
label var F23 "23. SI LE HUBIERA RESULTADO A.. żESTABA DISPONIBLE  LA  SEMANA PASADA PARA…"
...
label var O42 "42. DURANTE LAS ULT 4 SEM  żHA BUSCADO TRABAJO?"
...
label var O45 "45. ż....DESEA CAMBIAR EL  TRABAJO  QUE  TIENE ACTUALMENTE?"
...
label var O48 "48. SI LE RESULTARA UN NUEVO TRABAJO O EMPLEO żPODRIA EMPEZAR A "
...
label var I62 "62.  DESPUÉS DE  SU ULTIMO TRABAJO żHA HECHO ALGUNA DILIGENCIA…"
label var I63 "63.  ż....HA BUSCADO TRABAJO ALGUNA VEZ?"
...
label var ANO "AŃO DE LA ENCUESTA" 
