...
******************************
egen idh_ch=group(c_w ed hhnum)
...
g condocup_ci=.
replace condocup_ci=1 if majactv==1 | (reasab>=1 & reasab<=3)
...
replace cesante_ci=0 if worklwe==1 | everwrkd ==2 
...
*********************************
/*gen spublico_ci=.
replace spublico_ci=1 if  emplstat==2
replace spublico_ci=0 if  emplstat!=2 & emplstat!=9
...
raza_ci  raza_idioma_ci id_ind_ci id_afro_ci relacion_ci civil_ci jefe_ci nconyuges_ch nhijos_ch	notropari_ch notronopari_ch	nempdom_ch ///
