...
save "$ruta\survey\BRA\PNAD\1999\m9\data_orig\Noasiste.dta", replace
...
save "$ruta\survey\BRA\PNAD\1999\m9\data_orig\Asiste.dta", replace
append using "$ruta\survey\BRA\PNAD\1999\m9\data_orig\Noasiste.dta"
