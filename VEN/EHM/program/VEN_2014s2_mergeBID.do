...
use "`base_in'\hog142.dta", clear
sort entidad control linea serie num_hog 
egen id = group(entidad control linea serie num_hog)
duplicates report id
g pesoh = peso
saveold "`base_in'\hog142_.dta", replace
  
use "`base_in'\per142.dta", clear
sort entidad control linea serie num_hog 
egen id = group(entidad control linea serie num_hog)
duplicates report id
g pesop = peso
saveold "`base_in'\per142_.dta", replace 
  
use "`base_in'\viv142.dta", clear
sort entidad control linea serie 
duplicates report entidad control linea serie total_hoga
g pesov = peso
drop peso
saveold "`base_in'\viv142_.dta", replace 



use "`base_in'\per142_.dta", clear

merge m:1 id using "`base_in'\hog142_.dta"

drop _merge

merge m:1 entidad control linea serie total_hoga using "`base_in'\viv142_.dta"
