...
gen rentaimp_ch=v19ede  /*v21ede for 2006; Si tuviera que alquilar esta vivienda cuanto estimaría que le Pag.. por mes*/
replace rentaimp_ch=. if v19ede>=15000000 /*v21ede for 2006 */
...
gen bano_ch=1 if v13>=1 & v13!=.
replace bano_ch=0 if v13==0
