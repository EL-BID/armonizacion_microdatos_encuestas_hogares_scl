...
gen desemp3_ci=.
(32526 missing values generated)

replace desemp3_ci=0 if desemp2==0 
(22559 real changes made)
...
(12062 real changes made)

replace pea1=0 if emp==0 & desemp1==0
(10909 real changes made)
...
(12115 real changes made)

replace pea2=0 if emp==0 & desemp2==0
(10856 real changes made)
...
(12200 real changes made)

replace pea3=0 if emp==0 & desemp3==0
(10771 real changes made)
