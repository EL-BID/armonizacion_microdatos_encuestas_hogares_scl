...
use "`base_in'\path18.dta", clear
tostring ageyrs, replace
sort serial ind
save, replace

use "`base_in'\povline18.dta", clear
tostring ageyrs, replace
sort serial ind
save, replace
...
merge m:1 serial ind using "`base_in'\path18.dta"
drop _merge 
sort serial ind

merge m:m serial ind using "`base_in'\povline18.dta"
drop _merge 
sort serial ind
...
order edwght finwght a9* a10 a20 a21 b5_distance b6_distance b7_distance t_meal t_noncon i24_1 tot_tax tot_wat tot_telec tot_telel tot_mort rent hhsize1 hhsize2 tcgift, last
