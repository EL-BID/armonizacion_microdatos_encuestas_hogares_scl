...
*** average week of the survey is 11.32
replace mes_c=10  if mes_c==.
label variable mes_c "Mes de la Encuesta: Segundo Semestre de 1998"
...
*********
gen lp_ci=.
replace lp_ci=39449.6 if zona_c==1
replace lp_ci=31559.7 if zona_c==0
...
gen salmm_ci=.
replace salmm_ci=100000/1000 if zona_c==1 /*en Bs*/
replace salmm_ci=90000/1000 if zona_c==0 
...
***subemp_ci***
***************
/*Variable dicotómica que indica con valor 1 si la persona trabaja 30 o menos horas a la semana en */
