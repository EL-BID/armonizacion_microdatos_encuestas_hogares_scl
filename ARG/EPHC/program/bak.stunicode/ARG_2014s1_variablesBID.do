...
replace aedu_ci=18 	if aedu_ci==. & eduuc_ci==1
	...
	*piso_ch*
	*********
*20190716 Modificado por SGR. 
	gen piso_ch=0 if iv3==3
	replace piso_ch=1 if iv3==1 | iv3==2
	replace piso_ch=. if iv3==0 | iv3==4
...
*20190716 Modificado por SGR. 
	...
	replace techo_ch=. if iv4==9
	replace techo_ch=1  if iv4==9 & iv5==1
	replace techo_ch=0  if iv4==9 & iv5==2
...
*************
gen tecnica_ci=.
*Ch12==1 corresponde a jardÃ­n/preescolar, no hay variable tÃ©cnica.
/*
