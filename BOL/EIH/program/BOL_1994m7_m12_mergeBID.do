...
use "X:\ARM\BOL\1994\Orig_data\eih7_viv.dta"
sort hide
gen h901h = h901
label var h901h "Ponderador del hogar"

save "X:\ARM\BOL\1994\Orig_data\eih7_vivtemp.dta", replace

clear all

use "X:\ARM\BOL\1994\Orig_data\eih7_pob.dta", clear
rename hide hide1
...
merge m:m hide using "X:\ARM\BOL\1994\Orig_data\eih7_vivtemp.dta"
tab _merge
...
label var hide1 "Identificador del individuo"
 ...
 save "X:\ARM\BOL\1994\Orig_data\bol94.dta", replace
