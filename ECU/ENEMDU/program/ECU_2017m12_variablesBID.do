...
*Javier
	...
	***pqnoasis_ci***
	**************
	replace p09 = 17 if p09 == 16	//JV: Aquí la variable ya viene con labels, y establece que 16 es "otra", por eso la cambio para ser consistente con los otros años
	gen pqnoasis_ci=p09
	...
	***aguamide_ch***
	*****************
	gen aguamide_ch=(vi16a==1) if vi16a!=.
    ...
    ***aguamejorada_ch***
    *********************
	g       aguamejorada_ch = 1 if (vi16 >=1 & vi16 <=3) | vi16 ==5  | vi16 ==7
	replace aguamejorada_ch = 0 if  vi16 ==4  | vi16 ==6
    *********************
    ***banomejorado_ch***
    *********************
	g       banomejorado_ch = 1 if (vi13 >=1 & vi13 <=4)
	replace banomejorado_ch = 0 if  vi13 ==5 
