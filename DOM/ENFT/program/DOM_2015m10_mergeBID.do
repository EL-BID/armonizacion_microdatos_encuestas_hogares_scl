...
import excel "`base_in'\Base ENFT Octubre 2015.xls", sheet("`mod'") firstrow case(lower) clear
...
merge m:m eft_vivienda eft_hogar eft_miembro using "`base_in'\Ingresos_Exterior.dta", force
tab _merge
drop _merge
sort eft_vivienda
