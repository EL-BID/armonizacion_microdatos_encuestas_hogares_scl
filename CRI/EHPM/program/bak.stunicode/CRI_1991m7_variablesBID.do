...
capture drop lp_ci
gen lp_ci = .
replace lp_ci =          7116 if zona_c==1
replace lp_ci =          5536 if zona_c==0
...
gen lpe_ci = .
replace lpe_ci =  3264 if zona_c==1
replace lpe_ci = 2810 if zona_c==0
...
* 1991 junio (fuente OIT-CEPAL observatorio de la crisis)
gen salmm_ci= 17630.17
