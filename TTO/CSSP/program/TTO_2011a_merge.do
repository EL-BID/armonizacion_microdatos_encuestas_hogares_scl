...
use "`base_in'\hh_data_2011.dta", clear
...
saveold "`base_in'\Household_2011.dta", replace


*** Base a nivel de individuos
use "`base_in'\Private Persons Data (11)Census.dta", clear
...
saveold "`base_in'\Persons_2011.dta", replace


*** MERGE ***

merge m:1 idh_ch using "`base_in'\Household_2011.dta"
keep if _merge==3
