...
saveold "$ruta\634-Modulo18\enaho01-2018-612_1.dta", replace

* Sort de bases
use "$ruta\634-Modulo02\enaho01-2018-200.dta", clear
duplicates report conglome vivienda hogar codperso
sort conglome vivienda hogar codperso
saveold "$ruta\634-Modulo02\enaho01-2018-200.dta", replace


use "$ruta\634-Modulo03\enaho01a-2018-300.dta", clear
duplicates report conglome vivienda hogar codperso
sort conglome vivienda hogar codperso
saveold "$ruta\634-Modulo03\enaho01a-2018-300.dta", replace


use "$ruta\634-Modulo04\enaho01a-2018-400.dta", clear
duplicates report conglome vivienda hogar codperso
sort conglome vivienda hogar codperso
saveold "$ruta\634-Modulo04\enaho01a-2018-400.dta", replace


use "$ruta\634-Modulo05\enaho01a-2018-500.dta", clear
duplicates report conglome vivienda hogar codperso
sort conglome vivienda hogar codperso
saveold "$ruta\634-Modulo05\enaho01a-2018-500.dta", replace


use "$ruta\634-Modulo85\enaho01b-2018-2.dta", clear
duplicates report conglome vivienda hogar codperso
sort conglome vivienda hogar codperso
saveold "$ruta\634-Modulo85\enaho01b-2018-2.dta", replace


use "$ruta\634-Modulo34\sumaria-2018.dta", clear
duplicates report conglome vivienda hogar
sort conglome vivienda hogar 
saveold "$ruta\634-Modulo34\sumaria-2018.dta", replace


use "$ruta\634-Modulo18\enaho01-2018-612_1.dta", clear
duplicates report conglome vivienda hogar
sort conglome vivienda hogar
saveold "$ruta\634-Modulo18\enaho01-2018-612_1.dta", replace
...
clear
use "$ruta\634-Modulo01\enaho01-2018-100.dta", clear
keep if result==1 | result==2
sort conglome vivienda hogar
merge 1:m conglome vivienda hogar using "$ruta\634-Modulo04\enaho01a-2018-400.dta", force
drop _merge

sort conglome vivienda hogar codperso
merge 1:1 conglome vivienda hogar codperso using "$ruta\634-Modulo02\enaho01-2018-200.dta"
drop _merge

sort conglome vivienda hogar codperso
merge 1:1 conglome vivienda hogar codperso using "$ruta\634-Modulo03\enaho01a-2018-300.dta", force
drop _merge

sort conglome vivienda hogar codperso
merge 1:1 conglome vivienda hogar codperso using "$ruta\634-Modulo05\enaho01a-2018-500.dta", force
drop _merge

sort conglome vivienda hogar codperso
merge 1:1 conglome vivienda hogar codperso using "$ruta\634-Modulo85\enaho01b-2018-2.dta", force
drop _merge

sort conglome vivienda hogar
merge m:1 conglome vivienda hogar  using "$ruta\634-Modulo34\sumaria-2018.dta", force
drop _merge

sort conglome vivienda hogar
merge m:1 conglome vivienda hogar using "$ruta\634-Modulo18\enaho01-2018-612_1.dta"
drop _merge

capture drop if p203 ==0

saveold "$out\PER_2018a.dta", replace
