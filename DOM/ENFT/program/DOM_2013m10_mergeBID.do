...
/*
foreach file in "`base_in'\miembrosenft2013.dta" "`base_in'\ocupacionenft2013.dta" "`base_in'\calculadasenft2013.dta" "`base_in'\remesasenft2013.dta" "`base_in'\ingresexteriorenft2013.dta" {
use "`file'", clear
sort  eft_vivienda eft_hogar eft_miembro
saveold "`file'", replace
}

use "`base_in'\viviendaenft2013.dta", clear
sort eft_vivienda 
saveold "`base_in'\viviendaenft2013.dta", replace

use "`base_in'\hogarenft2013.dta", clear
sort eft_vivienda eft_hogar
saveold "`base_in'\hogarenft2013.dta", replace
*/
*Consolidando la información*
*****************************
use "`base_in'\miembrosenft2013.dta", clear

merge m:m eft_vivienda eft_hogar eft_miembro using "`base_in'\ocupacionenft2013.dta", force
tab _merge
...
merge m:m eft_vivienda eft_hogar eft_miembro using "`base_in'\calculadasenft2013.dta", force
tab _merge
drop _merge
sort eft_vivienda eft_hogar eft_miembro

merge m:m eft_vivienda eft_hogar eft_miembro using "`base_in'\remesasenft2013.dta", force
tab _merge
tab eft_edad if _merge==1
drop _merge
sort eft_vivienda eft_hogar eft_miembro

merge m:m eft_vivienda eft_hogar eft_miembro using "`base_in'\ingresexteriorenft2013.dta", force
tab _merge
drop _merge
sort eft_vivienda

merge m:m eft_vivienda using "`base_in'\viviendaenft2013.dta", force
tab _merge
drop _merge
sort eft_vivienda eft_hogar 

merge m:m eft_vivienda eft_hogar  using "`base_in'\hogarenft2013.dta", force
tab _merge
drop _merge
