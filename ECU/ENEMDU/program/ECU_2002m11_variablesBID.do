...
*/
 ...
 /*
 gen raza_ci=.
 replace raza_ci=1  if pe14 == 1
 replace raza_ci=2 if pe14 == 4 | pe14 == 5
...
*	Mod Ivan B./EDU 2015,12
	...
	***pqnoasis_ci***
	**************
	gen pqnoasis_ci=pe08 if (pe08>=1 & pe08<=13)
...
label var tecnica_ci "=1 formacion terciaria tecnica"
	...
	*************
	...
	gen bano_ch = (vi06!=5)
	replace bano_ch=. if vi06==.
	label var bano_ch "El hogar tiene servicio sanitario"

	***************
	***banoex_ch***
	***************
	gen banoex_ch= (vi07==1)
	replace banoex_ch=. if vi07==.
    ...
    ***banomejorado_ch***
    *********************
	g       banomejorado_ch = 1 if (vi06 >=1 & vi06 <=4) & vi07 == 1
	replace banomejorado_ch = 0 if ((vi06 >=1 & vi06 <=4) & vi07 == 2) | vi06 ==5 
