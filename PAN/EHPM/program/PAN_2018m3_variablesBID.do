...
**************
gen aguadisp1_ch = . 
replace aguadisp1_ch = 1 if v1j1_veran==7 & v1j1_invie==7 & v1j2_veran==24 & v1j2_invie==24
replace aguadisp1_ch = 0 if v1j1_veran<7 & v1j1_invie<7 & v1j2_veran<24 & v1j2_invie<24
