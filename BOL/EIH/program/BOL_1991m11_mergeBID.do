...
local in = "X:\ARM\BOL\1991\Programs\Van_prog\"
local out = "X:\ARM\BOL\1991\Van_data\"
...
use "X:\ARM\BOL\1991\Orig_data\491`y'.dta"
renpfix v `y'_
rename `y'_1 identifi
sort identifi
desc
summ
save "X:\ARM\BOL\1991\Van_data\491`y'.dta", replace
clear }
