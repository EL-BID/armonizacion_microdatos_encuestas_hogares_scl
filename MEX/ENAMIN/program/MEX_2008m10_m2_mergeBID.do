...
global ruta = "\\Sdssrv03\surveys\\survey\MEX\ENAMIN\2008\m10_m2\data_orig"
...
sort ent  con  v_sel  n_hog h_mud n_ren
...
sort  ent  con  v_sel  n_hog h_mud n_ren	
merge ent  con  v_sel  n_hog h_mud n_ren using "$ruta\princip1_1.dta"
tab _merge
keep if _merge==3
drop _merge
sort  ent  con  v_sel  n_hog h_mud n_ren	
merge ent  con  v_sel  n_hog  h_mud  n_ren using "$ruta\princip2_1.dta"
tab _merge
keep if _merge==3
drop _merge
sort  ent  con  v_sel  n_hog h_mud n_ren	
merge ent  con  v_sel  n_hog  h_mud  n_ren using "$ruta\ing_gast_1.dta"
tab _merge
keep if _merge==3
drop _merge
sort  cd_a  ent  con  v_sel  n_hog h_mud n_ren	
