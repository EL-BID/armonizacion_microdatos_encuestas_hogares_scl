...
g aux1 = substr(caseid,1,15)
destring aux1, replace //para borrar los 6 espacios en blanco del inicio.
tostring aux1, replace
g laux1=length(aux1)
egen id1 = concat(z3 aux1) if laux1 ==6
egen id2 = concat(z2 aux1) if laux1 ==7
egen id3 = concat(z1 aux1) if laux1 ==8


g idhogar1 = aux1 if laux1 ==9
replace idhogar1 = id1 if laux1 ==6
replace idhogar1 = id2 if laux1 ==7
replace idhogar1 = id3 if laux1 ==8

g aux = substr(idhogar1,1,7)
...
g aux = substr(hhid,1,13)

/*egen idhogar1 = concat(hv001aux hv002aux hvidxaux)
egen idhogar2 = concat(hv001aux hv002aux hvidxaux)*/
egen idhogar1 = concat(aux hvidxaux)
egen idhogar2 = concat(aux hvidxaux)

sort idhogar1 idhogar2

*merge m:m idhogar1 using "$ruta\survey\PER\DHS\2012\m3_m12\data_orig\PEBR6IFL_MADRE.DTA"
*drop if _merge ==2
*capture drop _merge
...
g idh = substr(hhid,1,13)
g idh2 = substr(idhogar1, 1,7)


destring idh, replace //para borrar los 6 espacios en blanco del inicio.
tostring idh, replace
capture drop laux1 id1 id2 id3
g laux1=length(idh)
egen id1 = concat(z3 idh) if laux1 ==4
egen id2 = concat(z2 idh) if laux1 ==5
egen id3 = concat(z1 idh) if laux1 ==6


g idhogar = idh if laux1 ==7
replace idhogar = id1 if laux1 ==4
replace idhogar = id2 if laux1 ==5
replace idhogar = id3 if laux1 ==6
replace idhogar = idh2 if laux1 ==1

sort idhogar

*saveold "$ruta\survey\PER\DHS\2012\m3_m12\data_orig\PEPR6IFL_HOGAR.DTA", replace

drop lninho aux1 leng leng2 idh idh2 laux1 id1 id2 id3 z3 z2 z1 lhv001 lhv002 lhvidx v11 v12 v13 v21 v22 v31 hv001aux hv002aux hvidxaux aux _merge

saveold "$ruta\survey\PER\DHS\2012\m3_m12\data_merge\PER_2012m3_m12.dta", replace
