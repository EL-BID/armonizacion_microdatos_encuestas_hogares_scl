...
****idh_ch*****
***************
egen idh_ch=group(a_met ent mun con v_sel hog h_mud) 
label var idh_ch "ID del hogar"

***************
****idp_ci*****
***************
egen idp_ci=group(idh_ch r_trh)
...
*	factor_ci
******************************
destring a_met, replace
gen zona_c=1 if a_met>=1 & a_met<=43
replace zona_c=2 if a_met>=44 & a_met<=86
...
****condocup_ci*
****************
destring p1e p2b1_1 p2b1_2 p2c, replace
gen condocup_ci=.
replace condocup_ci=1 if p1e==0
replace condocup_ci=2 if p1e==1 | (p2b1_2==1| (p2b1_2==2 & p2c==1)) 
replace condocup_ci=3 if condocup_ci!=1 & condocup_ci!=2 & p1e==2
...
destring p7d_5 p7d_4, replace
gen formal_ci=.
replace formal_ci=1 if condocup_ci==1 & (p7d_4==1 | p7d_5==1)
replace formal_ci=0 if condocup_ci==1 & (p7d_4==2 | p7d_5==2) & formal_ci!=1
...
g categopri_ci=.
replace categopri_ci=1 if p3a==1 & condocup_ci==1
replace categopri_ci=2 if (p3a==2 | p3a==5) & condocup_ci==1
replace categopri_ci=3 if (p3a==3 | p3a==4) & condocup_ci==1
replace categopri_ci=4 if (p3a>=6 & p3a<=7) & condocup_ci==1
...
*/
destring p3e, replace
gen tamemp_ci=.
replace tamemp_ci=1 if (p3e==1 | p3e==2) & condocup_ci==1
replace tamemp_ci=2 if (p3e>=3 & p3e<=5) & condocup_ci==1
replace tamemp_ci=3 if (p3e>=6 & p3e<=8) & condocup_ci==1
