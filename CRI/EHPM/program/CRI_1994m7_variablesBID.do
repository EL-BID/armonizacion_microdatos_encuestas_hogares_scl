...
capture drop lp_ci
gen lp_ci = .
replace lp_ci =       10998 if zona_c==1
replace lp_ci =       8552 if zona_c==0
...
gen lpe_ci = .
replace lpe_ci =        5045 if zona_c==1
replace lpe_ci =        4341 if zona_c==0
...
* 1994 junio (fuente OIT-CEPAL observatorio de la crisis)
gen salmm_ci= 24794.9
...
*educacion**Secundaria (académica y técnica)
