...
use "`base_in'\calculadas2004.dta"
sort eft_vivienda eft_hogar eft_miembro
save, replace
clear

use "`base_in'\ocupacion2004.dta"
sort eft_vivienda eft_hogar eft_miembro
save, replace
clear

use "`base_in'\ingexterior2004.dta"
sort eft_vivienda eft_hogar eft_miembro
save, replace
clear

use "`base_in'\remesas2004.dta"
sort eft_vivienda eft_hogar eft_miembro
save, replace
clear

use "`base_in'\miembros2004.dta"
sort eft_vivienda eft_hogar eft_miembro
save, replace

merge eft_vivienda eft_hogar eft_miembro using "`base_in'\remesas2004.dta"
tab _merge
drop _merge
sort eft_vivienda eft_hogar eft_miembro
save "`base_in'\dom2004_october.dta", replace

merge eft_vivienda eft_hogar eft_miembro using "`base_in'\ingexterior2004.dta"
tab _merge
drop _merge
sort eft_vivienda eft_hogar eft_miembro
save "`base_in'\dom2004_october.dta", replace

merge eft_vivienda eft_hogar eft_miembro using "`base_in'\ocupacion2004.dta"
tab _merge
drop _merge
sort eft_vivienda eft_hogar eft_miembro
save "`base_in'\dom2004_october.dta", replace

merge eft_vivienda eft_hogar eft_miembro using "`base_in'\calculadas2004.dta"
tab _merge
drop _merge
sort eft_vivienda eft_hogar eft_miembro
save "`base_in'\dom2004_october.dta", replace
...
clear 
use "`base_in'\hogar2004.dta"
sort eft_vivienda eft_hogar 
save, replace

clear 
use "`base_in'\dom2004_october.dta"
sort eft_vivienda eft_hogar 

merge eft_vivienda eft_hogar using "`base_in'\hogar2004.dta"
tab _merge
drop _merge
save "`base_in'\dom2004_october.dta", replace

clear 
use "`base_in'\vivienda2004.dta"
sort eft_vivienda
save, replace
...
merge eft_vivienda using "`base_in'\vivienda2004.dta"
tab _merge
drop _merge
save "`base_in'\dom2004_october.dta", replace
