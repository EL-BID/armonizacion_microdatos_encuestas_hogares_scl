...
use `base_in', clear
	...
	*Region
	g region_c = 16 if v101 == 1
	replace region_c = 26 if v101 ==2
	replace region_c = 4  if v101 ==3
	replace region_c = 27 if v101 ==4
	replace region_c = 28  if v101 ==5
	replace region_c = 11  if v101 ==6
	replace region_c = 29  if v101 ==7
	replace region_c = 30  if v101 ==8
	replace region_c = 31  if v101 ==9
	replace region_c = 13  if v101 ==10
	replace region_c = 22  if v101 ==11
	replace region_c = 25  if v101 ==12
	replace region_c = 15  if v101 ==13
