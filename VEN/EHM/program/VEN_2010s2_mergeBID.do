...
*--------
use hog102.dta, clear
joinby entidad control linea serie using viv102.dta,  _merge(_merge)
tab _merge
drop _merge

joinby entidad control linea serie num_hog using per102.dta, _merge(_merge)
tab _merge
drop _merge
...
saveold "\\Sdssrv03\surveys\survey\VEN\EHM\2010\s2\data_merge\VEN_2010s2.dta", replace
