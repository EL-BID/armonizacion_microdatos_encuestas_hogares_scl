...
idh_ch (idhogar)
************/
gen codusu1= substr(codusu,1,1)+substr(codusu,3,2)+substr(codusu,6,1)+substr(codusu,-4,4)
gen str2 ciudad=string(aglomera)
gen str13 idh_ch=codusu1+ciudad
drop ciudad
...
drop segsoc_ci
gen segsoc_ci=.
replace segsoc_ci=1 if benef2==11 | benef2==12 | benef2==14
recode segsoc_ci .=0 if pea_ci==1 & desemp_ci==0
