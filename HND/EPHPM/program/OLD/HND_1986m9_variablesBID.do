...
replace ylmotros_ci=yocups if yocups<9999 & edad>9 & yocups>0

replace ylmotros_ci=ganocups if ganocups<9999 & edad>9 & ganocups>0
...
replace nrylmpri_ci=1 if yocupp==9999

replace nrylmpri_ci=1 if ganocupp==9999
...
gen categopri_ci=2 if categ==4 | categ==5 | categ==6
...
gen desemp3_ci=.
replace desemp3_ci=0 if desemp1==0 
replace desemp3_ci=1 if desemp1==1 | buscomes==1 
label var desemp3_ci "desemp1 + personas que no tienen trabajo pero han buscado trabajo durante las 4 semanas anteriores a la semana pasada"
...
*tamemp_ci
*************
recode perstrab (1=1) (2=2) (3=3) (4=4) (nonmissing=.), gen(tamemp_ci)
label var tamemp_ci "# empleados en la empresa"
label define tamemp_ci  1 "De 1 a 2 personas" 2 "De 3 a 4 personas" 3 "De 5 a 9 personas" 4 "De 10 personas y mas"
...
replace vivialq_ch=pagomens if pagomens>0
