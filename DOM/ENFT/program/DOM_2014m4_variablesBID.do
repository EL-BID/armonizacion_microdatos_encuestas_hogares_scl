...
Fecha última modificación: 13 de Abril de 2015
...
1/2014	1	42.76 (Peso)
1/2014	2	1 (Dolares)
1/2014	5	1.07 (Dolar Canadiense)
1/2014	13	1.03 (Franco)
1/2014	14	.73 (Euro)
*/	
...
*Si la información está en dólares se multiplica por 42.76


*Modulo Ingresos del Exterior
gen pension_int=monto_ing_pension_mes	 		    if  moneda_ing_pension_mes==1
replace pension_int=monto_ing_pension_mes*42.76   	if  moneda_ing_pension_mes==2
replace pension_int=(monto_ing_pension_mes*1.07)*42.76     if  moneda_ing_pension_mes==5
replace pension_int=(monto_ing_pension_mes*0.73)*42.76     if  moneda_ing_pension_mes==14
replace pension_int=. if recibio_ing_pension_mes==2


gen interes_int=monto_ing_interes_mes	 		    if  moneda_ing_interes_mes==1
replace interes_int=monto_ing_interes_mes*42.76	    if  moneda_ing_interes_mes==2
replace interes_int=(monto_ing_interes_mes*1.07)*42.76 	if  moneda_ing_interes_mes==5
replace interes_int=(monto_ing_interes_mes*0.73)*42.76  if  moneda_ing_interes_mes==14
...
replace r_jul=monto_jul*42.76 	if moneda_jul==2
replace r_jul=(monto_jul*1.07)*42.76 	if moneda_jul==5
replace r_jul=(monto_jul*0.73)*42.76 	if moneda_jul==14

gen r_ago=monto_ago		    	if moneda_ago==0
replace r_ago=monto_ago		    if moneda_ago==1
replace r_ago=monto_ago*42.76 	if moneda_ago==2
replace r_ago=(monto_ago*1.07)*42.76 	if moneda_ago==5
replace r_ago=(monto_ago*0.73)*42.76 	if moneda_ago==14

gen r_sep=monto_sep 	    	if moneda_sep==0
replace r_sep=monto_sep 		if moneda_sep==1
replace r_sep=monto_sep*42.76 	if moneda_sep==2
replace r_sep=(monto_sep*1.07)*42.76 	if moneda_sep==5
replace r_sep=(monto_sep*0.73)*42.76 	if moneda_sep==14
...
replace pqnoasis1_ci = 3 if motivo_no_asiste==6  | motivo_no_asiste==9
...
replace pqnoasis1_ci = 9 if motivo_no_asiste==4  | motivo_no_asiste==5 | motivo_no_asiste==10 | motivo_no_asiste==11
