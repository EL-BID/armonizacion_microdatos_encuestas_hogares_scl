...
global ruta = "\\Sdssrv03\surveys\\survey\GTM\ENEI\2016\m10\data_orig"
local PAIS GTM
local ENCUESTA ENEI
local ANO "2016"
local ronda m10
...
use "$ruta\enei_ii_2016_hogares.dta", clear
sort num_hogar
saveold "$ruta\enei_ii_2016_hogares_.dta", version(12) replace

use "$ruta\enei_ii_2016_personas.dta", clear
sort num_hog
merge m:1 num_hogar using "$ruta\enei_ii_2016_hogares.dta"
drop _merge
