...
global ruta = "\\Sdssrv03\surveys\\survey\\BHS\LFS\\2009\\a\\data_orig"
...
use  "$ruta\Bahamas_LFS_2009_housing.dta", clear
capture drop id
egen id=concat(island sup_dist enum_dist_no household_no)
sort id
save "$ruta\Bahamas_LFS_2009_housing.dta", replace

use "$ruta\Bahamas_LFS_2009_individual.dta", clear
egen id=concat(island sup_dist enum_dist_no household_no)
sort id
merge id using "$ruta\Bahamas_LFS_2009_housing.dta"
tab _merge
drop _merge
