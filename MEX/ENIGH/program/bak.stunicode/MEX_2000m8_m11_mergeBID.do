...
2) Bit�coras: "${surveysFolder}\pobreza ingresos\2000\Log"
...
*********************************************************
*
*	PROGRAMA PARA LA MEDICI�N DE LA POBREZA 2000
*
*********************************************************
...
As�, se sabe que la encuesta fue levantada entre los meses 
de agosto y noviembre, y por lo tanto, al preguntarse por 
los ingresos de los seis meses anteriores, se recolect� 
informaci�n correspondiente a febrero-julio, marzo-agosto,
abril-septiembre, y mayo-octubre*/

*Definici�n de los deflactores 2000
...
*La estrategia para deflactar ser� dividir cada columna 
...
**Modificaci�n Mayra S�enz - Julio 2015 : En la sintaxis original de CONEVAL s�lo generan ing_mon, los otros ingresos se generan con base en sintaxis anteriores.
...
g double dona_pu  = 0                                                                 
g double dona_pr  = ing_mens if  (clave=="P031" | clave=="P032")                      //Becas y donaciones provenientes de Instituciones, Regalos y donativos originados dentro del pa�s
g double otros   = ing_mens  if  ((clave>="P035" & clave<="P036"))                     //Venta de autom�viles, aparatos electricos de segunda mano, etc.  Otros ingresos corrientes no considerados en los anteriores, (viáticos, etc.).
...
*A continuaci�n se estima el total de ingresos de cada 
...
*Creaci�n del gasto monetario deflactado a pesos de agosto de 2000.
...
/*En el caso de la informaci�n de gasto, para deflactar se 
utiliza la decena de levantamiento de la encuesta, la cual 
se encuentra en la s�ptima y octava posici�n del folio 
...
/*Al comparar con la informaci�n del cat�logo, se observa que la 
informaci�n se levant� en nueve decenas, correspondientes a:
...
en otro a�os, se recodifican*/

recode decena (11=1) (12=2) (13=3) (14=4) (15=5) (16=6) (17=7) (18=8) (19=9)

/*As�, para realizar el an�lisis, y conforme a lo establecido 
en la informaci�n de la ENIGH2000, se tomar�n como periodos 
de referencia:
...
Vivienda y servicios de conservaci�n	/Mensual	/d3mmes
Estimaci�n del alquiler	/No se deflactar�	/No se deflactar�
Art�culos y servicios de limpieza	/Mensual	/d42mmes
Cristaler�a y utensilios dom�sticos	/Trimestral	/d42tmesini
...
Transporte for�neo	/Semestral	/d6smesini
...
*rubros de gasto de la metodolog�a del CTMP
...
*Gasto en Vivienda y servicios de conservaci�n deflactado
...
*Gasto en Enseres dom�sticos y muebles deflactado
...
Los deflactores se crean previamente a partir del INPC seg�n
aparece en la Nota T�cnica.
...
encuesta, la cual se encuentra en la s�ptima y octava 
posici�n del folio del hogar. Primero se obtiene 
...
*Se eliminan las claves de estimaci�n del valor del alquiler 
*conceptualmente id�nticas
...
*Construcci�n de la base de autoconsumo a partir de la 
...
*Construcci�n de la base de pagos en especie a partir de 
...
*Construcci�n de la base de regalos a partir de la base de no monetario
...
personas, se calculan los coeficientes de Engel del a�o
en curso, y se calcula la incidencia de la pobreza de 
acuerdo con la metodolog�a del CTMP y el c�lculo oficial 
de la Sedesol.
...
/*Construcci�n del indicador del tama�o de la localidad 
...
saveold "$ruta\gtos_autoc00.dta", replace //Mayra S�enz Julio 2015
...
egen double ict=rsum(ing_monh nomon)                 if parentes=="01" | parentes=="02" //Mayra S�enz Agosto 2015 - Aumento esta condici�n porque esta base est� a nivel de personas
egen double gct=rsum(gasmon nomon)                   if parentes=="01" | parentes=="02" //Mayra S�enz Agosto 2015 - Aumento esta condici�n porque esta base est� a nivel de personas
egen double gnt=rsum(gasmon nomon redan reg_espn)    if parentes=="01" | parentes=="02" //Mayra S�enz Agosto 2015 - Aumento esta condici�n porque esta base est� a nivel de personas
egen double intt=rsum(ing_monh nomon redan reg_espn) if parentes=="01" | parentes=="02" //Mayra S�enz Agosto 2015 - Aumento esta condici�n porque esta base est� a nivel de personas
