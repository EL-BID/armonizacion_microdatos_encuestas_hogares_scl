...
saveold "$ruta\498-Modulo18\enaho01-2015-612_1.dta", replace

* Sort de bases
use "$ruta\498-Modulo02\enaho01-2015-200.dta", clear
duplicates report conglome vivienda hogar codperso
sort conglome vivienda hogar codperso
saveold "$ruta\498-Modulo02\enaho01-2015-200.dta", replace


use "$ruta\498-Modulo03\enaho01a-2015-300.dta", clear
duplicates report conglome vivienda hogar codperso
sort conglome vivienda hogar codperso
saveold "$ruta\498-Modulo03\enaho01a-2015-300.dta", replace


use "$ruta\498-Modulo04\enaho01a-2015-400.dta", clear
duplicates report conglome vivienda hogar codperso
sort conglome vivienda hogar codperso
saveold "$ruta\498-Modulo04\enaho01a-2015-400.dta", replace


use "$ruta\498-Modulo05\enaho01a-2015-500.dta", clear
duplicates report conglome vivienda hogar codperso
sort conglome vivienda hogar codperso
saveold "$ruta\498-Modulo05\enaho01a-2015-500.dta", replace


use "$ruta\498-Modulo85\enaho01b-2015-2.dta", clear
duplicates report conglome vivienda hogar codperso
sort conglome vivienda hogar codperso
saveold "$ruta\498-Modulo85\enaho01b-2015-2.dta", replace


use "$ruta\498-Modulo34\sumaria-2015.dta", clear
duplicates report conglome vivienda hogar
sort conglome vivienda hogar 
saveold "$ruta\498-Modulo34\sumaria-2015.dta", replace


use "$ruta\498-Modulo18\enaho01-2015-612_1.dta", clear
duplicates report conglome vivienda hogar
sort conglome vivienda hogar
saveold "$ruta\498-Modulo18\enaho01-2015-612_1.dta", replace
...
clear
use "$ruta\498-Modulo01\enaho01-2015-100.dta", clear
keep if result==1 | result==2
sort conglome vivienda hogar
merge 1:m conglome vivienda hogar using "$ruta\498-Modulo04\enaho01a-2015-400.dta", force
drop _merge

sort conglome vivienda hogar codperso
merge 1:1 conglome vivienda hogar codperso using "$ruta\498-Modulo02\enaho01-2015-200.dta"
drop _merge

sort conglome vivienda hogar codperso
merge 1:1 conglome vivienda hogar codperso using "$ruta\498-Modulo03\enaho01a-2015-300.dta", force
drop _merge

sort conglome vivienda hogar codperso
merge 1:1 conglome vivienda hogar codperso using "$ruta\498-Modulo05\enaho01a-2015-500.dta", force
drop _merge

sort conglome vivienda hogar codperso
merge 1:1 conglome vivienda hogar codperso using "$ruta\498-Modulo85\enaho01b-2015-2.dta", force
drop _merge

sort conglome vivienda hogar
merge m:1 conglome vivienda hogar  using "$ruta\498-Modulo34\sumaria-2015.dta", force
drop _merge

sort conglome vivienda hogar
merge m:1 conglome vivienda hogar using "$ruta\498-Modulo18\enaho01-2015-612_1.dta"
drop _merge

capture drop if p203 ==0

saveold "$out\PER_2015a.dta", replace
