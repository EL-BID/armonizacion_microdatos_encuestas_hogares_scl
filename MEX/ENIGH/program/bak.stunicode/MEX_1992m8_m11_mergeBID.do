...
g double trat_pu  = 0
g double dona_pu  = 0                                                                 
g double dona_pr  = ing_mens if  (clave=="P025" | clave=="P026")                      //Becas y donaciones provenientes de Instituciones, Regalos y donativos originados dentro del pa�s
g double otros   = ing_mens  if ((clave>="P028" & clave<="P029"))                     //Venta de autom�viles, aparatos electricos de segunda mano, etc.  Otros ingresos corrientes no considerados en los anteriores, (viáticos, etc.).
...
*Los deflactores se crean previamente a partir del INPC según aparece en la Nota Técnica.
...
*Al comparar con la información del catálogo, se observa que la información se levantó en nueve decenas, correspondientes a:
...
*Gasto en Educacion básica deflactado
...
saveold "$ruta\gtos_autoc.dta", replace //Mayra S�enz Julio 2015
