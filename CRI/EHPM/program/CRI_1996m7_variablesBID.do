...
capture drop lp_ci
gen lp_ci = .
replace lp_ci =     15149 if zona_c==1
replace lp_ci =     11741 if zona_c==0
...
gen lpe_ci = .
replace lpe_ci =      6949 if zona_c==1
replace lpe_ci =      5960 if zona_c==0
...
* 1996 junio (fuente OIT-CEPAL observatorio de la crisis)
gen salmm_ci= 38012
