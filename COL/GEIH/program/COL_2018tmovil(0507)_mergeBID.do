...
*----------------------------------------------
use "`ruta'\`ronda1'\data_orig\anual_homologado_DANE\Hogares `anio'.dta", clear
rename *, lower
save `pobreza_hogares', replace

use "`ruta'\`ronda1'\data_orig\anual_homologado_DANE\Personas `anio'.dta", clear
rename *, lower
...
use "`m1'\`zona' - Caracteristicas generales (Personas).dta", clear
rename *, lower
