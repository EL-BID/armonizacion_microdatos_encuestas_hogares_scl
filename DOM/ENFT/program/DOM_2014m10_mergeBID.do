...
*Abril 2015
		*************************************************************
		***PROGRAMA PARA PEGAR LOS MÓDULOS DE LA ENFT Octubre 2014***
		*************************************************************
clear
...
merge m:m eft_vivienda eft_hogar eft_miembro using "`base_in'\Ocupacion.dta", force
tab _merge
...
merge m:m eft_vivienda eft_hogar eft_miembro using "`base_in'\Calculadas.dta", force
tab _merge
drop _merge
sort eft_vivienda eft_hogar eft_miembro

merge m:m eft_vivienda eft_hogar eft_miembro using "`base_in'\Remesas.dta", force
tab _merge
tab eft_edad if _merge==1
drop _merge
sort eft_vivienda eft_hogar eft_miembro

merge m:m eft_vivienda eft_hogar eft_miembro using "`base_in'\Ingresos exterior.dta", force
tab _merge
drop _merge
sort eft_vivienda

merge m:m eft_vivienda using "`base_in'\Vivienda.dta", force
tab _merge
drop _merge
sort eft_vivienda eft_hogar 

merge m:m eft_vivienda eft_hogar  using "`base_in'\Hogar.dta", force
tab _merge
drop _merge
