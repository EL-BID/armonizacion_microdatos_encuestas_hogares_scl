...
gen ocupa = . ;
if (aglomera==3 | (aglomera>=7 & aglomera<=9) | aglomera==12 | aglomera==15 | (aglomera>=18 & aglomera<=27) | aglomera==31) {;
local ocup = "ocupa";
local var = "p20";
...
gen ocupa_ci = .
replace ocupa_ci = 1 if (((p20>=111 & p20<=149) | (p20>=211 & p20<=239)) & emp_ci==1
replace ocupa_ci = 2 if (p20 >=11 & p20 <=99) & emp_ci==1		
replace ocupa_ci = 3 if (p20>=111 & p20<=249) & emp_ci==1
