...
*cd "\\yessenial\s\Data.idb\ARM\JAM\2010\JSLC\Data" 
...
gen NIVEL2=0 if b1==1 | b1==20 | b1==3 
replace NIVEL2=1 if b1==2 | b1==4 | b1==6 /* PRIMARIO */
replace NIVEL2=2 if b1==7 | b1==8 | b1==9 /* 1 CICLO SECUNDARIO */
replace NIVEL2=3 if b1==11 | b1==12  /* 2 CICLO SECUNDARIO */
replace NIVEL2=4 if b1>=14 & b1<=16 /* TERCIARIO / UNIVERSITARO */
...
replace aedu_ci=GRADO-1 if aedu>=ageyrs & GRADO<. 
replace aedu_ci=0 if b1==19 & b1==20
...
gen eduno_ci=.
replace eduno_ci=1 if b1==19 & b1==20
...
*replace edusc_ci=1 if (GRADO2==11)
...
gen eduac_ci=.
*replace eduac_ci=0 if b1==14 | b1==15 | b1==15 | b1==16
*replace eduac_ci=1 if b1==13 | b1==14
...
*save "\\yessenial\s\Data.idb\ARM\JAM\2010\JSLC\Arm data\JAM2010EA_BID.dta", replace 
