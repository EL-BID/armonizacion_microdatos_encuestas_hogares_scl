...
infile using "${input}\input_2020t.do", using("${input}\PNADC_042020.txt")
 ...
 *________________________________________________________________________________________________________________*
 ...
 1,564  BRA/PNADC/program/BRA_2020t4_variablesBID.do 
@@ -0,0 +1,1564 @@
* (Versión Stata 13)
clear
set more off
...
Fecha última modificación: Febrero de 2021
****************************************************************************/
****************************************************************************/
...
***universidad_ci**
*************
gen universidad_ci=. /*No se puede identificar educación técnica superior*/
