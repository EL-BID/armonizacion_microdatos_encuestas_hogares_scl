...
*************
* COL 2004
gen salmm_ci= 	11933.3333333333 * 22
...
*Total horas
egen tothoras=rowtotal(promhora promhora1 hora_ad)
replace tothoras=. if promhora==. & promhora1==. & hora_ad==.
...
replace NIVEL=3	if C10>=400 & C10<=413
...
replace aedu_ci=10 if C10==410 
replace aedu_ci=11 if C10==411 | C10==500 
replace aedu_ci=12 if C10==412 /* Y.L -> 12 años de educacion secundaria "son muy pocos"*/
replace aedu_ci=13 if C10==413 /* Y.L -> 13 años de educacion secundaria "son muy pocos"*/
...
replace edus2c_ci=1 if (aedu_ci>=11 & aedu_ci<=13) & NIVEL==3
