...
use `base_in', clear
	...
	*Region
	...
	7 "Callao" 8 "Cusco" 9 "Huancavelica" 10 "Huanuco" 11 "Ica" 12 "Junin" 13 "La Libertad" 14 "Lambayeque" ///
	15 "Lima" 16 "Loreto" 17 "Madre De Dios" 18 "Moquegua" 19 "Pasco" 20 "Piura" 21 "Puno" 22 "San Martin" ///
	23 "Tacna" 24 "Tumbes" 25 "Ucayali", add modify
	...
	*Para identificar si vive en Lima Capital - Tomo la variable de facto place of residence
	...
	label var capital_c "Personas que viven en Lima=1"
	...
	*Factor de Expansion a nivel individual
	g factor_ch   = hv005
	label var factor_ch "Factor de Expansion de los miembros del Hogar"
...
order region_BID_c region_c capital_c zona_c upm_c estrato_c conglomerado_c pais_c anio_c factor_ch idh_ch ///
 idp_ci mes_c quintil_ch relacion_ci sexo_ci edad_ci civil_ci nmiembros_ch miembros_ci aedu_ci nivedu_ci  ///
 agua_ch luz_ch radio_ch tv_ch refrig_ch bici_ch moto_ch auto_ch telef_ch id_ma anacim_ni mnacim_ni edadm_ni ///
 edada_ni sexo_ni gemelo_ni ordnacim_ni nherma_ni vivo_ni difedada_ni difedadm_ni difedad_ni edadalmorm_ni ///
 edadalmord_ni difencnacim_ni raza_ma mnacim_ma anacim_ma edad_ma edadparto_ma aedu_ma nivedu_ma, first
