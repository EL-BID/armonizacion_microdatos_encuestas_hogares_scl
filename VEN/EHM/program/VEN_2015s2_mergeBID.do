...
use "`base_in'\hog152.dta", clear
sort entidad control linea serie num_hog 
egen id = group(entidad control linea serie num_hog)
duplicates report id
g pesoh = peso
saveold "`base_in'\hog152_.dta", replace
  
use "`base_in'\per152.dta", clear
sort entidad control linea serie num_hog 
egen id = group(entidad control linea serie num_hog)
duplicates report id
g pesop = peso
saveold "`base_in'\per152_.dta", replace 
  
use "`base_in'\viv152.dta", clear
sort entidad control linea serie 
duplicates report entidad control linea serie total_hoga
g pesov = peso
drop peso
saveold "`base_in'\viv152_.dta", replace 



use "`base_in'\per152_.dta", clear

merge m:1 id using "`base_in'\hog152_.dta"

drop _merge

merge m:1 entidad control linea serie total_hoga using "`base_in'\viv152_.dta"
