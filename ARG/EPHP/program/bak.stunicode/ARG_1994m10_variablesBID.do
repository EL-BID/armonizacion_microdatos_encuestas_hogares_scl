...
replace  p471= p47_1 if anio_c==1994 & p471==.
...
egen ylm_ci=rowtotal(p471 p472 p473),m
...
egen ynlm_ci=rowtotal(p473 p474 p475 p476),m
...
No disponible para 1993 y 1994
***********/
*Modificación Mayra Sáenz - Marzo 2014
*gen aedu_ci=0
gen aedu_ci=.
...
gen ocupa = . ;
if  (aglomera==2 | aglomera==4 | aglomera==8 | aglomera==9 | aglomera==12 | (aglomera>=18 & aglomera<=27) | aglomera==31){;
local ocup = "ocupa";
local var = "p20";
...
replace capital_ci= p474 if categopri_ci==1
