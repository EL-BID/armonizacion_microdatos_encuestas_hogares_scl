...
**Pregunta: a qué nación o pueblo pertenece? (s3a_2bcod) (AFROBOLIVIANO 001 - TODAS LAS OTRAS CATEGORIAS SON INDIGENAS)


gen afroind_ci=. 
replace afroind_ci=1  if s3a_2a==1 & s3a_2bcod!="001"
replace afroind_ci=2 if s3a_2bcod=="001"
