...
*lp1_ci***
*********
generat lp1_ci =1047.94 if zona_c==1
replace lp1_ci = 779.21 if zona_c==0
...
*lp3_ci***
*********
generat lp3_ci =2102.59 if zona_c==1
replace lp3_ci =1413.95 if zona_c==0
...
replace segsoc_ci=1 if (pres_91=="09")
...
replace firmapeq_ci=1 if tam_emp1==01 | tam_emp1==02
...
replace aguadist_ch= 3 if dis_agua==4 | dis_agua==6
...
***aguamejorada_ch***
*********************
g       aguamejorada_ch = 1 if (dis_agua  >=1 &  dis_agua <=3)  
replace aguamejorada_ch = 0 if (dis_agua  >=4 &  dis_agua <=6)
		
*********************
***banomejorado_ch***
*********************
g       banomejorado_ch = 1 if (excus  ==1  & (drenaje >=1 &  drenaje<=2) & uso_com == 2)
replace banomejorado_ch = 0 if (excus  ==1  & (drenaje >=1 &  drenaje<=2) & uso_com == 1) | excus  ==2 | (excus  ==1  & (drenaje >=3 &  drenaje<=5))
