...
foreach file in annual94 heads94 hhsize94 housing94 noncons94 notfood94 povline94 rec00194 rec00294 rec00394 rec00494 rec00594 rec00694 rec00794 rec00894 rec00994 rec01094 rec01194 rec01294 rec01394 rec01494 rec01594 rec01694 rec01794 rec01894 rec01994 rec02094 rec02194 rec02294 rec02394 rec02494 rec02594 rec02694 rec02794 rec02894 rec02994 rec03094 rec03194 thomfood94 thousexp94 tnoncons94 tnotfood94  toilets94 totfood94 totgifts94 totmeals94	{
	usespss using "${surveysFolder}\survey\JAM\SLC\1994\m11\data_orig\spss\\`file'.sav"
	foreach v of varlist _all {
	local lowname=lower("`v'")
	rename `v' `lowname'
}
saveold "${surveysFolder}\survey\JAM\SLC\1994\m11\data_orig\stata\\`file'.dta", replace
clear all
set more off
}
...
foreach t in annual94 hhsize94 housing94 rec00194 rec00994 rec01794 rec02094 rec02194 rec02294 rec02594 rec02794 rec03094 thomfood94 thousexp94 tnoncons94 tnotfood94  toilets94 totfood94 totgifts94 totmeals94 {
	set more off
	use "${surveysFolder}\survey\JAM\SLC\1994\m11\data_orig\stata\\`t'.dta"
	di "`t'"
...
clear all
use "${surveysFolder}\survey\JAM\SLC\1994\m11\data_orig\stata\annual94.dta"
foreach t in hhsize94 housing94 rec00194 rec00994 rec01794 rec02094 rec02194 rec02294 rec02594 rec02794 rec03094 thomfood94 thousexp94 tnoncons94 tnotfood94  toilets94 totfood94 totgifts94 totmeals94 {
	merge m:m serial using "${surveysFolder}\survey\JAM\SLC\1994\m11\data_orig\stata\\`t'.dta"
	di "`t'"
	tab _merge
	drop _merge
	}
sort serial
saveold "${surveysFolder}\survey\JAM\SLC\1994\m11\data_orig\stata\hogares.dta", replace
...
*Merge personas
clear all
use "${surveysFolder}\survey\JAM\SLC\1994\m11\data_orig\stata\heads94.dta"
foreach t in povline94 rec00294 rec00394 rec00494 rec00594 rec00694 rec00794 rec00894 rec01194 rec01494 rec01894 rec01994 rec03194 {
	merge m:m serial ind using "${surveysFolder}\survey\JAM\SLC\1994\m11\data_orig\stata\\`t'.dta"
	di "`t'"
	tab _merge
	drop _merge
	}
sort serial
saveold "${surveysFolder}\survey\JAM\SLC\1994\m11\data_orig\stata\personas.dta", replace

merge m:m serial using  "${surveysFolder}\survey\JAM\SLC\1994\m11\data_orig\stata\hogares.dta"
tab _merge
drop _merge
saveold "${surveysFolder}\survey\JAM\SLC\1994\m11\data_merge\JAM_1994m11.dta", replace
