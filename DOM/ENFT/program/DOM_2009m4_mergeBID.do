		***********************************************************
		***PROGRAMA PARA PEGAR LOS MÓDULOS DE LA ENFT ABRIL 2009***
		***********************************************************
...
use "`base_in'\calculadas09.dta", clear
sort eft_vivienda eft_hogar eft_miembro
save, replace
clear

use "`base_in'\ocupacion09.dta", clear
sort eft_vivienda eft_hogar eft_miembro
save, replace
clear

use "`base_in'\ingexterior09.dta", clear
sort eft_vivienda eft_hogar eft_miembro
save, replace
clear

use "`base_in'\remesas09.dta", clear
sort eft_vivienda eft_hogar eft_miembro
save, replace
clear

use "`base_in'\miembros09.dta", clear
sort eft_vivienda eft_hogar eft_miembro
save, replace

merge eft_vivienda eft_hogar eft_miembro using "`base_in'\remesas09.dta"
tab _merge
drop _merge
sort eft_vivienda eft_hogar eft_miembro
save "`base_in'\dom09_april.dta", replace

merge eft_vivienda eft_hogar eft_miembro using "`base_in'\ingexterior09.dta"
tab _merge
drop _merge
sort eft_vivienda eft_hogar eft_miembro
save "`base_in'\dom09_april.dta", replace

merge eft_vivienda eft_hogar eft_miembro using "`base_in'\ocupacion09.dta"
tab _merge
drop _merge
sort eft_vivienda eft_hogar eft_miembro
save "`base_in'\dom09_april.dta", replace

merge eft_vivienda eft_hogar eft_miembro using "`base_in'\calculadas09.dta"
tab _merge
drop _merge
sort eft_vivienda eft_hogar eft_miembro
save "`base_in'\dom09_april.dta", replace
...
clear 
use "`base_in'\hogar09.dta"
sort eft_vivienda eft_hogar 
save, replace

clear 
use "`base_in'\dom09_april.dta"
sort eft_vivienda eft_hogar 

merge eft_vivienda eft_hogar using "`base_in'\hogar09.dta"
tab _merge
drop _merge
save "`base_in'\dom09_april.dta", replace

clear 
use "`base_in'\vivienda09.dta"
sort eft_vivienda
save, replace
...
merge eft_vivienda using "`base_in'\vivienda09.dta"
tab _merge
drop _merge
