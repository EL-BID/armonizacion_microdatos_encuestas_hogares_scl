...
use "`base_in'\household data (99).dta", clear
...
saveold "`base_in'\Household_1999.dta", replace


*** Base a nivel de individuos
use "`base_in'\Private Persons Data (99).dta", clear
...
saveold "`base_in'\Persons_1999.dta", replace


*** MERGE ***

merge m:1 idh_ch using "`base_in'\Household_1999.dta"
keep if _merge==3
