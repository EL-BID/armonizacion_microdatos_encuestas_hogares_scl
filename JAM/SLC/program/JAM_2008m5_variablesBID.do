...
*set memory 200m
*set more off
*use "\\yessenial\s\Data.idb\ARM\JAM\2008\JSLC\data\jam08a.dta"
...
label define mes_c 1"JAN" 2 "FEB" 3"MAR" 4"APR" 5"MAY" 7"JUL" 8"AUG" 9"SEP" 10"OCT" 11"NOV" 12"DEC"
...
*Modificación Mayra Sáenz : Desactivo las recodificaciones, pues ya se incorporaron en  el merge.
...
gen resid_ch=.
replace resid_ch=0 if i33==1 | i33==2 | i33==3
replace resid_ch=1 if i33==4 | i33==5
replace resid_ch=2 if i33==6 | i33==7 | i33==8 | i33==9
replace resid_ch=3 if i33==10
...
***aguamejorada_ch***
*********************
g       aguamejorada_ch = 1 if (i20 >=1 & i20 <=4) | (i20 >=6 & i20 <=7)
replace aguamejorada_ch = 0 if  i20==5 | (i20 >=8 & i20 <=13)
...
gen compu_ch=.
replace compu_ch=1 if i34==1 | i34==2 | i34==3
replace compu_ch=0 if i34==4
...
destring i35, replace

gen internet_ch=.
replace internet_ch=1 if i35==1 | i35==2 | i35==3 | i35==4
replace internet_ch=0 if i35==5

**********
* cel_ch *
**********
destring i30_2, replace

gen cel_ch=.
replace cel_ch=1 if i30_2==1
replace cel_ch=0 if i30_2==2
