...
*/
	...
	*Variable agregada por Iván Bornacelly - 01/16/2017
	g asispre_ci=.
	replace asispre_ci=1 if pe01==1 & (pe02a==2 | pe02a==3)
	recode asispre_ci (.=0)
	...
	***pqnoasis_ci***
	**************
	*Esta variable no tiene opciones predeterminadas por los que se mantienen las opciones del paî³
	*ModificaciÃ³n SGR 2017/05/09 se cambia la opciÃ³n 6 de "Temor a los maestros" a "Asistir a nivelaciÃ³n SENESCYT"
	gen pqnoasis_ci=p09
	label var pqnoasis_ci "Razones para no asistir a la escuela"
	label def pqnoasis_ci 1"edad" 2"terminÃ³ sus estudios" 3"falta recursos econÃ³micos" 4"fracaso escolar"
	label def pqnoasis_ci 5"por trabajo" 6"por asistir a nivelaciÃ³n SENESCYT" 7"enfermedad o discapacidad" 8"quehaceres del hogar", add
	label def pqnoasis_ci 9"familia no permite" 10"no hay establecimientos educativos" 11"no estÃ¡ interesado", add
	*ModificaciÃ³n SGR 2017/05/09 
	*label def pqnoasis_ci 12"por embarazo" 13"por falta de cupo" 14"Temor a los compaÃ±eros" 15"Cuidar a los hijos" 16"Otra razÃ³n" , add
	label def pqnoasis_ci 12"por embarazo" 13"por falta de cupo" 14"Otra razÃ³n" , add
