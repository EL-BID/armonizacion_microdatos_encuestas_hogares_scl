...
*/
	gen categopri_ci=.
	replace categopri_ci=1 if cate==3 
...
*************
g rama_ci=.
replace rama_ci=1 if (rama>=111 & rama<=500) & emp_ci==1
...
replace rama_ci=8 if (rama>=6511 & rama<=7020) & emp_ci==1
replace rama_ci=9 if (rama>=7111 & rama<=9999) & emp_ci==1
