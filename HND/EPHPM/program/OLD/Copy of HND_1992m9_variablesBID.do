...
gen antiguedad=anostrab if emp==1 & anostrab<99 & anostrab>0
...
gen desemp3_ci=.
(24704 missing values generated)

replace  desemp3_ci=0 if desemp2==0 
(17242 real changes made)
...
(8597 real changes made)

replace  pea1=0 if emp==0 & desemp1==0
(8928 real changes made)
...
(8624 real changes made)

replace  pea2=0 if emp==0 & desemp2==0
(8901 real changes made)
...
(8712 real changes made)

replace  pea3=0 if emp==0 & desemp3==0
(8813 real changes made)
