...
global ruta = "\\Sdssrv03\surveys\\survey\PRY\EPH\2014\m10_m12\data_orig"
...
forvalues i = 1/9 {
use "$ruta\r0`i'_eph2014.dta", clear
cap sort upm nvivi nhoga
cap sort upm nvivi nhoga l02
save, replace
}
forvalues i = 10/13 {
use "$ruta\r`i'_eph2014.dta", clear
cap sort upm nvivi nhoga 
cap sort upm nvivi nhoga l02
save, replace
}
...
use "$ruta\r13_eph2014.dta", replace
...
save "$ruta\r13_eph2014_mod.dta", replace


/*Unifico los modulos de interés para el sociometro:
  Vivienda, ingresos y personas*/
 
use "$ruta\r02_eph2014.dta", clear
merge m:1 upm nvivi nhoga using "$ruta\r01_eph2014.dta"
drop _merge
sort upm nvivi nhoga l02

merge m:m upm nvivi nhoga using "$ruta\r03_eph2014.dta", force
drop _merge
sort upm nvivi nhoga

merge m:m upm nvivi nhoga using "$ruta\r13_eph2014_mod.dta", force
drop _merge
sort upm nvivi nhoga

merge m:1 upm nvivi nhoga using "$ruta\ingrefam eph 2014.dta", force
drop _merge
sort upm nvivi nhoga
