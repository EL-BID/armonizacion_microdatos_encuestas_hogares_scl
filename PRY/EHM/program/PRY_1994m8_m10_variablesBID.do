...
replace yedc=10 if ultano==34
replace yedc=11 if ultano==35
replace yedc=12 if ultano==36


*** universitario o superior
replace yedc=13 if ultano==51 | ultano==41
replace yedc=14 if ultano==52 | ultano==42
replace yedc=15 if ultano==53 | ultano==43
replace yedc=16 if ultano==54 | ultano==44 
replace yedc=17 if ultano==55 
replace yedc=18 if ultano==56
...
replace asiste_ci=0 if asiste==2 |  asiste==3
label variable asiste_ci "Asiste actualmente a la escuela"

* MR: se clasifica la opción no a enseñanza regular como No = 0
...
* Modificaciones Marcela Rubio: las categorias cambiaron en el cuestionario
gen aguared_ch=(agua==1 | agua==2)
...
* Modificaciones Marcela Rubio Septiembre 2014: corrección en pequeño error en sintaxis
/*
gen des1_ch=.
...
replace des1_ch=1 if servsani==1 | servsani==3
replace des1_ch=2 if servsani==4 | servsani==2
replace des1_ch=3 if servsani==5
...
replace telef_ch=1 if telefono==10
