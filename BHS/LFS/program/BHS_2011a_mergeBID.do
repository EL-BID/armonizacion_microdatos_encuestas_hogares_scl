...
global ruta = "\\Sdssrv03\surveys\\survey\\BHS\LFS\\2011\\a\\data_orig"
...
use  "$ruta\Bahamas_LFS_2011_housing.dta", clear
sort island hhno
save "$ruta\Bahamas_LFS_2011_housing.dta", replace

use "$ruta\Bahamas_LFS_2011_individual.dta", clear
sort island hhno

merge island hhno using "$ruta\Bahamas_LFS_2011_housing.dta"
tab _merge
drop _merge
