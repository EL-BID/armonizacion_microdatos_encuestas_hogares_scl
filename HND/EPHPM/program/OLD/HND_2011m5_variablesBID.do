...
/*version anterior - se reemplazo por condocup_ci************
***emp_ci***
************
...
replace ylmpri_ci=ce20      if ((ce20>0 & ce20!=.) & emp_ci==0) /*incremento el ingreso mensual de los desocupados)*/
replace ylmpri_ci=ce22      if ((ce22>0  & ce22!=.) & emp_ci==0) 
...
Nota: los miembros de coop deberian ser cuenta propia. No es muy alto en 2011. Solo 8 casos.
*/
gen categopri_ci=.
...
gen eduno_ci=.
replace eduno=1 if (ed05==1 & edad_ci>=5) | (ed10==1 & edad_ci>=5) 
replace eduno=0 if (ed05>2 & ed05<=9 & edad_ci>=5) | (ed10>2 & ed10<9) 
label var eduno_ci "1 = personas sin educacion (excluye preescolar)"

gen edupi_ci=.
replace edupi=1 if (ed05==4 & ed08<6 & ed08>=0) | (ed10==4 & ed15<6 & ed15>=0)
replace edupi=0 if ((ed05>=5 & ed05<=9) | (ed05==4 & ed08>=6)) | ((ed10>=5 & ed10<9) | (ed10==4 & ed15>=6)) | (eduno==1)
label var edupi_ci "1 = personas que no han completado el nivel primario"

gen edupc_ci=.
replace edupc=1 if (ed05==4 & ed08==6) | (ed10==4 & ed15==6) 
replace edupc=0 if (edupi==1 | eduno==1) | (ed05==4 & ed08>6) | (ed10==4 & ed15>=6) | (ed05>4 & ed05<=9) | (ed10>4 & ed10<9)
replace edupi=1 if ed05==4 & (ed08==0 | ed08==.)
replace edupi=1 if ed10==4 & (ed15==0 | ed15==.)
label var edupc_ci "1 = personas que han completado el nivel primario"

gen edusi_ci=.
replace edusi=1 if (ed05==4 & ed08>6 & ed08!=.) | (ed10==4 & ed15>=6 & ed15<.) | (ed05==5 & ed08<3) | (ed05==6 & ed08<4) | (ed10==5 & ed15<3) | (ed10==6 & ed15<4)
replace edusi=0 if (edupi==1 | eduno==1 | edupc==1) | (ed05==5 & ed08>=3 & ed08<.) | (ed05==6 & ed08>=4 & ed08<.) | (ed05>=7 & ed05<=9) | (ed10>=7 & ed10<=9) | (ed10==5 & ed15>=3 & ed15<.) | (ed10==6 & ed15>=4 & ed15<.) 
label var edusi_ci "1 = personas que no han completado el nivel secundario"

gen edusc_ci=.
replace edusc=1 if (ed05==5 & ed08>=3 & ed08!=.) | (ed05==6 & ed08>=4 & ed08!=.) | (ed10==5 & ed15>=3 & ed15!=.) | (ed10==6 & ed15>=4 & ed15!=.)
replace edusc=0 if (edupi==1 | eduno==1 | edupc==1 | edusi==1) | (ed05>6 & ed05<=9) | (ed10>6 & ed10<=9)
label var edusc_ci "1 = personas que han completado el nivel secundario"

gen eduui_ci=.
replace eduui=1 if (ed05==7 & ed08<3) | (ed05==8 & ed08<4) | (ed10==7 & ed15<3) | (ed10==8 & ed15<4) |(ed05==9 & ed08<4) | (ed10==9 & ed15<4)
replace eduui=0 if (edupi==1 | eduno==1 | edupc==1 | edusi==1 | edusc==1) | (ed05==7 & ed08>=3) | (ed05==8 & ed08>=4) | (ed10==7 & ed15>=3) | (ed10==8 & ed15>=4) |(ed05==9 & ed08>=4) | (ed10==9 & ed15>=4)

label var eduui_ci "1 = personas que no han completado el nivel universitario"

gen eduuc_ci=.
replace eduuc=1 if (ed05==7 & ed08>=3 & ed08<.) | (ed05==8 & ed08>=4 & ed08<.) | (ed10==7 & ed15>=3 & ed15<.) | (ed10==8 & ed15>=4 & ed15<.) |(ed05==9 & ed08>=4) | (ed10==9 & ed15>=4) | ed05==10 | ed10==10
...
replace edupi=1 if ed10==4 & ed15==.
replace edupc=0 if ed10==4 & ed15==.
replace edusi=1 if (ed10==5 | ed10==6) & ed15==.
replace edusc=0 if (ed10==5 | ed10==6) & ed15==.
replace eduui=1 if (ed10==7 | ed10==8) & ed15==.
replace eduuc=0 if (ed10==7 | ed10==8) & ed15==.
