...
append using "${surveysFolder}\survey\COL\GEIH\2020\t3\data_merge\COL_2020t3resto.dta" 
...
merge 1:1 id using "${surveysFolder}\survey\COL\GEIH\2020\a\data_merge\pov_t3.dta"
drop _merge

rename *, lower

saveold "${surveysFolder}\survey\COL\GEIH\2020\t3\data_merge\COL_2020t3.dta", replace
