...
use "`base_in'\hh_data_2004.dta", clear
...
saveold "`base_in'\Household_2004.dta", replace


*** Base a nivel de individuos
use "`base_in'\Private Persons Data (04).dta", clear
...
saveold "`base_in'\Persons_2004.dta", replace


*** MERGE ***

merge m:1 idh_ch using "`base_in'\Household_2004.dta"
keep if _merge==3
