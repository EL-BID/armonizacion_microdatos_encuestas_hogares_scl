...
capture drop lp_ci
gen lp_ci = .
replace lp_ci =         8685 if zona_c==1
replace lp_ci =         6791 if zona_c==0
...
gen lpe_ci = .
replace lpe_ci = 3984 if zona_c==1
replace lpe_ci = 3447 if zona_c==0
...
* 1992 junio (fuente OIT-CEPAL observatorio de la crisis)
gen salmm_ci= 21364.33
...
gen byte eduno_ci=0
replace eduno_ci=1 if niveduc<=0
