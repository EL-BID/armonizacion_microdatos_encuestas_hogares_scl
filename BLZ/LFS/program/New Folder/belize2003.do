...
cd "${surveysFolder}\ARM\BLZ\2003"


capture log close
log using "${surveysFolder}\ARM\BLZ\2003\Arm_data\BLZ2003EA_BID.log", replace
...
use "${surveysFolder}\ARM\BLZ\2003\Orig_data\belize03.dta", clear
...
ren urbrur q02
ren ednumber q03
* ren sample q04 not available for 2003 *
ren hhnumber q05
ren week q06
ren result q07
*sort qid
...
gen idp_ci= person2 /*  person2 for 2002 */
...
gen byte rama_ci=.
replace rama_ci=1 if indmisic>=0 & indmisic<1000 /* indmisic for 2003 */
...
replace aedu_ci= (formin - 1) if (yrcomple==. & yrscompl==. & formin>0)
...
gen eduuc_ci=. /*Not available for 2003 */
/*
...
* THEY ONLY HAVE A VARIABLE FOR INCOME GROUPS *
...
save "${surveysFolder}\ARM\BLZ\2003\Arm_data\BLZ2003EA_BID.dta", replace
log close
