...
gen zona_c= 1 if (tam_loc==1 | tam_loc==2)
...
*afiliado_ci****
****************
qui destring pres_* servmed* inscr_* inst_* atemed tam_emp1  contrato1, replace
...
*lp1_ci***
*********
generat lp1_ci =1197.42 if zona_c==1
replace lp1_ci = 896.74 if zona_c==0
...
*lp3_ci***
*********
generat lp3_ci =2402.51 if zona_c==1
replace lp3_ci =1627.23 if zona_c==0
...
label define tamemp_ci 1"1 persona" 2"2-5 personas" 3"6-10 personas" 4"11-15 personas" 5"16-20 personas" 6"21-30 personas" 7"31-50 personas" 8"51-100 personas" 9"101-250 personas" 10"251-500 personas" 11"501 a más personas" 12"No sabe"
