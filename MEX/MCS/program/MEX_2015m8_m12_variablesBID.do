...
*Daniela Zuluaga-Agosto 2017- Entre 2014 y 2014 el programa oportunidades cambia de nombre a prospera*
gen yp70mas=P044
gen yotroam=P045
...
*********
gen lp_ci =.
replace lp_ci=2600.79 if zona_c==1
replace lp_ci=1673.52 if zona_c==0
...
*********
gen lpe_ci =.
replace lpe_ci= 1281.24 if zona_c==1
replace lpe_ci= 910.28 if zona_c==0
...
*	combust_ch
******************************
replace combustible= "." if combustible=="&"
