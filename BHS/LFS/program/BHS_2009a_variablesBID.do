...
***eduui_ci***
**************
gen byte eduui_ci=((education==6 | education==5) & (highest_certi==5))
...
gen byte eduac_ci=1 if (education==6 | education==5)
