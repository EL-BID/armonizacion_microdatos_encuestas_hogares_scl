...
/*En este año se empieza a preguntar a todos los miembros del hogar
p558c:
           1 quechua
           2 aymara
...
/*gen raza_ci=.
replace raza_ci= 1 if  p558c == 1 |  p558c == 2 |  p558c ==3 
replace raza_ci= 2 if  p558c == 4
...
*En la encuesta 2019 se agrega la categoría 9. Perteneciente o parte de otro Pubelo indígena u originario

*
gen raza_ci=.
replace raza_ci= 1 if  p558c == 1 |  p558c == 2 |  p558c ==3 | p558c==9 /*Modificación SGR Julio 2020, agrego la categoría 9 Perteneciente o parte de otro Pueblo indigiena u originario. Modifico el año 2018 y 2017 también.*/
replace raza_ci= 2 if  p558c == 4
bys idh_ch: gen razjef=raza_ci if relacion_ci==1
bys idh_ch: egen razjef1 = max(razjef)
replace raza_ci=razjef1 if (raza_ci ==. & (p203 ==3 | p203==5))  // Modificación Mayra Sáenz Enero 2016, se incorpora a los nietos.
replace raza_ci=3 if raza_ci==. 
drop razjef razjef1
label define raza_ci 1 "Indígena" 2 "Afro-descendiente" 3 "Otros"
label value raza_ci raza_ci 
...
* Variables incluidas por SCL/MIG Fernando Morales
	...
	**********************
	...
	gen migantiguo5_ci=(migrante_ci==1 & p401g>10000 & p401g!=. & p401g!=999999)
	...
	**********************
	...
	gen migrantelac_ci=(inlist(p401g2,4002,4003,4004,4005,4006,4007,4009,4010,4011,4014,4015,4018,4019,4021,4022,4023,4024,4025,4026,4027,4030,4034,4035,4036,4037) & migrante_ci==1)
