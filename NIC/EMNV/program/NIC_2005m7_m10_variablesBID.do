...
*/
gen raza_ci=.
replace raza_ci= 1 if s2p10 ==1 | s2p10 ==3 | s2p10 ==4 | s2p10 ==5 | s2p10 ==7 | s2p10 ==8 | s2p10 ==9 | s2p10 ==10 | s2p10 ==11
replace raza_ci= 2 if s2p10 ==2 | s2p10 ==6
replace raza_ci= 3 if s2p10 ==12|raza_ci==.
...
*No se incluye la sintaxis de GDI en raza_ci, porque la variable enviada no está armonizada de acuerdo a los criterios establecidos
*para todos los países, es decir, únicamente con tres categorías

gen raza_auxci=.
replace raza_auxci= 1 if s2p10 ==1 | s2p10 ==3 | s2p10 ==4 | s2p10 ==8 | s2p10 ==9 | s2p10 ==10 | s2p10 ==11
replace raza_auxci= 2 if s2p10 ==6 
replace raza_auxci= 4 if s2p10 ==2
replace raza_auxci= 3 if s2p10 ==12|s2p10 ==7  |raza_ci==.

label define raza_auxci 1 "Indígena" 2 "Afro-descendiente" 3 "Otros"  4 "Afro-indígena"
label value raza_auxci raza_ci 
label value raza_auxci raza_ci
label var raza_auxci "Raza o etnia del individuo"

gen raza_idioma_ci=.

gen id_ind_ci = 0
replace id_ind_ci=1 if raza_auxci==1 | raza_auxci==4
label define id_ind_ci 1 "Indígena" 0 "Otros" 
label value id_ind_ci id_ind_ci 
label var id_ind_ci  "Indigena" 

gen id_afro_ci = 0
replace id_afro_ci=1 if raza_auxci==2 | raza_auxci==4
