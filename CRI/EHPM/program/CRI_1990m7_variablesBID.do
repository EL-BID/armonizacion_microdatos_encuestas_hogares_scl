...
capture drop lp_ci
gen lp_ci = .
replace lp_ci =   5585 if zona_c==1
replace lp_ci =   4308 if zona_c==0
...
gen lpe_ci = .
replace lpe_ci =  2562 if zona_c==1
replace lpe_ci =  2187 if zona_c==0
...
*En la variable ypension todos los valores son cero.
g aux_p =.
gen pension_ci=(inactiv==1)
label var pension_ci "1=Recibe pension contributiva"
...
* 1990 junio (fuente OIT-CEPAL observatorio de la crisis)
...
replace categopri_ci=4 if categpr==6 | categpr==7
