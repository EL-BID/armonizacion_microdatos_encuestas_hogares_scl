...
/*
* Cambian las opciones de la pregunta 9, la 6 es raza negra, 7 ninguno y 8 otro. LCM Dic2013
gen raza_ci=.
replace raza_ci= 1 if  (grupo ==1 | grupo ==2 | grupo ==4 | grupo ==5 |grupo ==8)
replace raza_ci= 1 if (idiapren==1 | idiapren==2 | idiapren== 4 | idiapren== 5) & raza_ci==.
replace raza_ci= 2 if  grupo ==6 
replace raza_ci= 3 if (grupo ==3 | grupo ==7) 
...
gen raza_idioma_ci = .
replace raza_idioma_ci= 1 if (idiapren==1 | idiapren==2 | idiapren== 4 | idiapren== 7) & raza_idioma_ci==.
replace raza_idioma_ci= 3 if (idiapren==3 | idiapren==5)& raza_idioma_ci==.
...
replace raza_ci= 1 if  (grupo ==1 | grupo ==2 | grupo ==4 | grupo ==5 |grupo ==8)
replace raza_ci= 2 if  grupo ==6 
replace raza_ci= 3 if (grupo ==7) 
bys idh_ch: gen aux=raza_ci if parentco==1
bys idh_ch: egen aux1 = max(aux)
