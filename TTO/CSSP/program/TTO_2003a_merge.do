...
use "`base_in'\hh_data_2003.dta", clear
...
saveold "`base_in'\Household_2003.dta", replace


*** Base a nivel de individuos
use "`base_in'\Private Persons Data (03).dta", clear
...
saveold "`base_in'\Persons_2003.dta", replace


*** MERGE ***

merge m:1 idh_ch using "`base_in'\Household_2003.dta"
keep if _merge==3
