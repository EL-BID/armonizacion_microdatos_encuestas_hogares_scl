...
Fecha última modificación:13 de octubre 2021 by Juan Camilo Perdomo/ jcamilop@iadb.org
...
clear all
global modulos "Viviendas Hogar Miembros"
foreach mod of global modulos {
import excel "`base_in'Base ENCFT 20201 - 20204", sheet("`mod'") firstrow case(lower) clear
keep if trimestre == 20204
