...
ren ocup ocup_orig
gen ocupa_ci=.
replace ocupa_ci=1 if (aux>=2110 & aux<=3480) &  emp_ci==1
replace ocupa_ci=2 if (aux>=1110 & aux<=1319) &  emp_ci==1
replace ocupa_ci=3 if (aux>=4110 & aux<=4223) &  emp_ci==1
replace ocupa_ci=4 if ((aux>=5210 & aux<=5230) | (aux>=9110 & aux<=9113)) &  emp_ci==1
replace ocupa_ci=5 if ((aux>=5110 & aux<=5169) | (aux>=9120 & aux<=9162)) &  emp_ci==1
replace ocupa_ci=6 if ((aux>=6111 & aux<=6152) | (aux>=9210 & aux<=9213)) &  emp_ci==1
replace ocupa_ci=7 if ((aux>=711
0 & aux<=8340) | (aux>=9310 & aux<=9333)) &  emp_ci==1
replace ocupa_ci=8 if (aux==110)          	   & emp_ci==1
replace ocupa_ci=9 if ((aux>=9334 & aux<=9999) | (aux==9170))& emp_ci==1
drop aux
*/
...
/*
generat rama_ci=. 
replace rama_ci= 1 if rb02==1 & emp_ci==1
replace rama_ci= 3 if rb02==2 & emp_ci==1
replace rama_ci= 4 if rb02==3 & emp_ci==1
replace rama_ci= 5 if rb02==4 & emp_ci==1
replace rama_ci= 6 if rb02==5 & emp_ci==1
replace rama_ci= 7 if rb02==6 & emp_ci==1
replace rama_ci= 8 if rb02==7 & emp_ci==1
replace rama_ci= 9 if rb02==8 & emp_ci==1
*/
...
**<5 and no education
replace yedc=0 if nivgra==0 | nivgra==1601| nivgra==1700 

*** preescolar o jardin o pre-primaria
replace yedc=0 if nivgra>=101 & nivgra<=212
...
replace yedc=11 if nivgra==605 | nivgra==705 | nivgra==802 | nivgra==803 | nivgra==902 |nivgra==1002  | nivgra==1203 |nivgra==1204 |nivgra==1303 |nivgra==1304 | nivgra==1403 | nivgra==1404
...
***************
/*
* MGR: no utilizamos variable ed03 ya que incluye a los que asistieron alguna vez
gen asiste_ci=.
...
gen asiste_ci=.
replace asiste_ci=1 if ed08>=1 & ed08<=17
replace asiste_ci=0 if ed08==18 | ed03==6
label variable asiste_ci "Asiste actualmente a la escuela"
