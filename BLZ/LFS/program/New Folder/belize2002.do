...
cd "${surveysFolder}\ARM\BLZ\2002"


capture log close
log using "${surveysFolder}\ARM\BLZ\2002\Arm_data\BLZ2002EA_BID.log", replace
...
use "${surveysFolder}\ARM\BLZ\2002\Orig_data\belize02.dta", clear
...
save "${surveysFolder}\ARM\BLZ\2002\Arm_data\BLZ2002EA_BID.dta", replace
log close
