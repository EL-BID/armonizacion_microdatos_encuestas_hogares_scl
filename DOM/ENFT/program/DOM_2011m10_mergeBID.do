		***********************************************************
		***PROGRAMA PARA PEGAR LOS MÓDULOS DE LA ENFT OCTUB 2011***
		***********************************************************
...
insheet using "`base_in'\Vivienda O2011.txt"
sort eft_vivienda 
save "`base_in'\Vivienda O2011.dta", replace

clear
insheet using "`base_in'\Hogar O2011.txt"
sort eft_vivienda eft_hogar 
save "`base_in'\Hogar O2011.dta", replace

clear
insheet using "`base_in'\ingexterior O2011.txt"
sort eft_vivienda eft_hogar eft_miembro
save "`base_in'\ingexterior O2011.dta", replace

clear
insheet using "`base_in'\remesas O2011.txt"
sort eft_vivienda eft_hogar eft_miembro
save "`base_in'\remesas O2011.dta", replace

clear
insheet using "`base_in'\calculadas O2011.txt"
sort eft_vivienda eft_hogar eft_miembro
save "`base_in'\calculadas O2011.dta", replace

clear
insheet using "`base_in'\ocupacion O2011.txt"
sort eft_vivienda eft_hogar eft_miembro
save "`base_in'\ocupacion O2011.dta", replace

clear
insheet using "`base_in'\miembro O2011.txt"
sort eft_vivienda eft_hogar eft_miembro
save "`base_in'\miembro O2011.dta", replace

*Consolidando la información*
*****************************

merge eft_vivienda eft_hogar eft_miembro using "`base_in'\ocupacion O2011.dta"
tab _merge
...
merge eft_vivienda eft_hogar eft_miembro using "`base_in'\calculadas O2011.dta"
tab _merge
drop _merge
sort eft_vivienda eft_hogar eft_miembro

merge eft_vivienda eft_hogar eft_miembro using "`base_in'\remesas O2011.dta"
tab _merge
tab eft_edad if _merge==1
drop _merge
sort eft_vivienda eft_hogar eft_miembro

merge eft_vivienda eft_hogar eft_miembro using "`base_in'\ingexterior O2011.dta"
tab _merge
drop _merge
sort eft_vivienda

merge eft_vivienda using "`base_in'\Vivienda O2011.dta"
tab _merge
drop _merge
sort eft_vivienda eft_hogar 

merge eft_vivienda eft_hogar  using "`base_in'\Hogar O2011.dta"
tab _merge
drop _merge
