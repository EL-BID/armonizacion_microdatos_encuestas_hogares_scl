		*************************************************************
		***PROGRAMA PARA PEGAR LOS MÓDULOS DE LA ENFT OCTUBRE 202005***
		*************************************************************
...
use "`base_in'\calculadas2005.dta"
sort eft_vivienda eft_hogar eft_miembro
save, replace
clear

use "`base_in'\ocupacion2005.dta"
sort eft_vivienda eft_hogar eft_miembro
save, replace
clear

use "`base_in'\ingexterior2005.dta"
sort eft_vivienda eft_hogar eft_miembro
save, replace
clear

use "`base_in'\remesas2005.dta"
sort eft_vivienda eft_hogar eft_miembro
save, replace
clear

use "`base_in'\miembros2005.dta"
sort eft_vivienda eft_hogar eft_miembro
save, replace

merge eft_vivienda eft_hogar eft_miembro using "`base_in'\remesas2005.dta"
tab _merge
drop _merge
sort eft_vivienda eft_hogar eft_miembro
save "`base_in'\dom2005_october.dta", replace

merge eft_vivienda eft_hogar eft_miembro using "`base_in'\ingexterior2005.dta"
tab _merge
drop _merge
sort eft_vivienda eft_hogar eft_miembro
save "`base_in'\dom2005_october.dta", replace

merge eft_vivienda eft_hogar eft_miembro using "`base_in'\ocupacion2005.dta"
tab _merge
drop _merge
sort eft_vivienda eft_hogar eft_miembro
save "`base_in'\dom2005_october.dta", replace

merge eft_vivienda eft_hogar eft_miembro using "`base_in'\calculadas2005.dta"
tab _merge
drop _merge
sort eft_vivienda eft_hogar eft_miembro
save "`base_in'\dom2005_october.dta", replace
...
clear 
use "`base_in'\hogar2005.dta"
sort eft_vivienda eft_hogar 
save, replace

clear 
use "`base_in'\dom2005_october.dta"
sort eft_vivienda eft_hogar 

merge eft_vivienda eft_hogar using "`base_in'\hogar2005.dta"
tab _merge
drop _merge
save "`base_in'\dom2005_october.dta", replace

clear 
use "`base_in'\vivienda2005.dta"
sort eft_vivienda
save, replace
...
merge eft_vivienda using "`base_in'\vivienda2005.dta"
tab _merge
drop _merge
save "`base_in'\dom2005_october.dta", replace
