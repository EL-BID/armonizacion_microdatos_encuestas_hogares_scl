...
clear
use "${surveysFolder}\survey\PER\ENAHO\1996\t3\data_orig\ena9631_.dta", clear
merge m:m idhogar using "${surveysFolder}\survey\PER\ENAHO\1996\t3\data_orig\ena9632_.dta"
tab _merge
capture drop _merge
merge m:m idhogar using "${surveysFolder}\survey\PER\ENAHO\1996\t3\data_orig\ena9634_.dta"
tab _merge
drop if _merge !=3
capture drop _merge
sort ubi seg viv hog
saveold "${surveysFolder}\survey\PER\ENAHO\1996\t3\data_orig\hogares.dta", replace
...
clear
use "${surveysFolder}\survey\PER\ENAHO\1996\t3\data_orig\ena9633_.dta", clear
sort ubi seg viv hog 
merge m:m ubi seg viv hog using "${surveysFolder}\survey\PER\ENAHO\1996\t3\data_orig\hogares.dta", force
tab _merge
drop if _merge !=3
drop _merge
compress
saveold "${surveysFolder}\survey\PER\ENAHO\1996\t3\data_merge\PER_1996t3.dta", replace
