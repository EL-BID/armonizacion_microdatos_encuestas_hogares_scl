* MERGE
* ARGENTINA EPH. CONTINUA. 2oSem. 2020
...
foreach modulo of local modulos {
		...
		import delimited "\\Sdssrv03\surveys\survey\ARG\EPHC\20`ano'\t3\data_orig\usu_`modulo'_T3`ano'.txt", encoding(ISO-8859-2) clear 
		save "\\Sdssrv03\surveys\survey\ARG\EPHC\20`ano'\t3\data_orig\usu_`modulo'_t3`ano'.dta", replace


		import delimited "\\Sdssrv03\surveys\survey\ARG\EPHC\20`ano'\t4\data_orig\usu_`modulo'_T4`ano'.txt", encoding(ISO-8859-2) clear 
		save "\\Sdssrv03\surveys\survey\ARG\EPHC\20`ano'\t4\data_orig\usu_`modulo'_t4`ano'.dta", replace
}
