...
use "`base_in'\hh_data_2010.dta", clear
...
saveold "`base_in'\Household_2010.dta", replace


*** Base a nivel de individuos
use "`base_in'\Private Persons Data (10 by region and police)_1.dta", clear
...
saveold "`base_in'\Persons_2010.dta", replace


*** MERGE ***

merge m:1 idh_ch using "`base_in'\Household_2010.dta"
keep if _merge==3
