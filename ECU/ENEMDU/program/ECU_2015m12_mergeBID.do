...
saveold "`ruta'\201512_enemdubdd_viviendahogar.dta", replace
...
merge m:1 area ciudad zona sector panelm vivienda hogar using "`ruta'\201512_enemdubdd_viviendahogar.dta"
drop _merge
