...
use "${surveysFolder}\ARM\HON\1994\Orig_data\hnd94.dta", clear
...
replace  emp_ci=1 if edad>9 & hrsocupp>0 & hrsocupp<99

replace  emp_ci=0 if edad>9 & hrsocupp==0
...
gen desemp1_ci=.
(27891 missing values generated)
...
label var desemp2_ci "desemp1 + personas que no tienen trabajo ni lo buscaron, pero esperan respuesta d
> e una solicitud de empleo, entrevista o temporada agricola"
...
replace  nempleos=2 if emp_ci==1 & pluriemp==1
