...
local t3   ="${surveysFolder}\survey\COL\ECH\2004\t3\data_orig\"
local out  ="${surveysFolder}\survey\COL\ECH\2004\t3\data_merge\"
...
clear
use "${surveysFolder}\survey\COL\ECH\2004\a\data_orig\anual_homologado DANE\data_orig\personas 2004.dta", clear
gen idh_ch =llave_hog
sort idh_ch
merge idh_ch using "${surveysFolder}\survey\COL\ECH\2004\a\data_orig\anual_homologado DANE\data_orig\hogares2004.dta"
tab _merge
drop _merge
...
keep  id pet- fex_c 
sort id
save "${surveysFolder}\survey\COL\ECH\2004\a\data_orig\anual_homologado DANE\data_merge\t3.dta", replace
...
sort id
merge 1:m  id using "${surveysFolder}\survey\COL\ECH\2004\a\data_orig\anual_homologado DANE\data_merge\t3.dta"
tab _merge
drop _merge
