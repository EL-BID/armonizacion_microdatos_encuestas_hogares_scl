...
**Pregunta: a qué nación o pueblo pertenece? (s03a_04n)(AFROBOLIVIANO 1 - ALL OTHER CATEGORIES ARE INDIGENOUS)
** La base original difiere de la base armonizada (s03a_04npioc vs s03a_04n). 

gen afroind_ci=. 
replace afroind_ci=1  if s03a_04==1 & s03a_04npioc!=1
replace afroind_ci=2 if s03a_04npioc==1 
...
*Primaria & Secundaria
replace aedu_ci = s05a_02b if s05a_02a==21 | s05a_02a==31 | s05a_02a==41 | s05a_02a==51

* Secundaria  sistema escolar antiguo 
replace aedu_ci = s05a_02b+5   if  s05a_02a==22 // Intermedio
replace aedu_ci = s05a_02b+5+3 if    s05a_02a==23 // Medio
...
replace aedu_ci = s05a_02b+3     if (s05a_02a==52)
...
replace aedu_ci = s05a_02b + 12     if s05a_02b <= 5 & (s05a_02a ==71 | s05a_02a ==72) // normal, universidad y técnico-tecnológico
replace aedu_ci = s05a_02b + 12 	if s05a_02a >=76 & s05a_02a <=81
replace aedu_ci = s05a_02b + 12 + 5 if s05a_02b <= 5 & (s05a_02a ==73 | s05a_02a ==74) // postgrado, maestria
replace aedu_ci = s05a_02b + 12 + 5 + 2 if s05a_02b <= 5 & (s05a_02a ==75) // doctorado

* Terminación nivel

replace aedu_ci = 12+4   if s05a_02a ==71 & s05a_02b == 8 //Terminó escuela normal
replace aedu_ci = 12+5   if s05a_02a ==72 & s05a_02b == 8 //Terminó universidad
replace aedu_ci = 12+5+1 if s05a_02a ==73 & s05a_02b == 8 //Terminó posgrado
replace aedu_ci = 12+5+2 if s05a_02a ==74 & s05a_02b == 8 //Terminó maestria
replace aedu_ci = 12+5+5 if s05a_02a ==75 & s05a_02b == 8 //Terminó doctorado
...
replace aguadist_ch=3 if (s01a_10==3 | s01a_10==11)
...
gen aguamala_ch=(s01a_10==7 | s01a_10==8 | s01a_10==9)
...
***aguamejorada_ch***
*********************
gen aguamejorada_ch = 1 if (s01a_10 >= 1 &  s01a_10 <=5) | s01a_10==8
replace aguamejorada_ch = 0 if (s01a_10 >= 6 &  s01a_10 <=7) | (s01a_10 >= 9 &  s01a_10 <=12)
