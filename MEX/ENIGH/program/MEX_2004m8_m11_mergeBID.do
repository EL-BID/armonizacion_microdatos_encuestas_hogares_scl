...
global ruta = "${surveysFolder}\\survey\MEX\ENIGH\2004\m8_m11\data_orig"
...
Base de ingresos: ingreso04.dta
Base de gasto monetario: gasto04.dta
Base de gasto no monetario: nomonetario04.dta
Base de concentrado: concentrado04.dta

En este programa se utilizan tres tipos de archivos, los cuales 
están ubicados en las siguientes carpetas:

1) Bases originales: "${surveysFolder}\pobreza ingresos\2004\ENIGH"
2) Bitácoras: "${surveysFolder}\pobreza ingresos\2004\Log"
3) Bases generadas: "${surveysFolder}\pobreza ingresos\2004\Resultados"


Para cambiar estas ubicaciones, se modifican los siguientes
globals 

gl data="${surveysFolder}\pobreza ingresos\2004\ENIGH"
gl log="${surveysFolder}\pobreza ingresos\2004\Log"
gl bases="${surveysFolder}\pobreza ingresos\2004\Resultados"

log using "$log\Pobreza por ingresos 2004.txt", text replace

*********************************************************
*
*	PROGRAMA PARA LA MEDICIÓN DE LA POBREZA 2004
*
*********************************************************
...
*Definición de los deflactores 2004

scalar ene04	= 	0.9814577 	
scalar feb04	= 	0.9873285 	
scalar mar04	= 	0.9906741 	
scalar abr04	= 	0.9921692 	
scalar may04	= 	0.9896805 	
scalar jun04	= 	0.9912667 	
scalar jul04	= 	0.9938648 	
scalar ago04	= 	1.0000000 	
scalar sep04	= 	1.0082684 	
scalar oct04	= 	1.0152514 	
scalar nov04	= 	1.0239118 	
scalar dic04	= 	1.0260267 	

*La estrategia para deflactar será dividir cada columna 
*de ingreso por el deflactor correspondiente a su mes

replace ing_6=ing_6/feb04 if meses=="070605040302"
replace ing_5=ing_5/mar04 if meses=="070605040302"
replace ing_4=ing_4/abr04 if meses=="070605040302"
replace ing_3=ing_3/may04 if meses=="070605040302"
replace ing_2=ing_2/jun04 if meses=="070605040302"
replace ing_1=ing_1/jul04 if meses=="070605040302"

replace ing_6=ing_6/mar04 if meses=="080706050403"
replace ing_5=ing_5/abr04 if meses=="080706050403"
replace ing_4=ing_4/may04 if meses=="080706050403"
replace ing_3=ing_3/jun04 if meses=="080706050403"
replace ing_2=ing_2/jul04 if meses=="080706050403"
replace ing_1=ing_1/ago04 if meses=="080706050403"

replace ing_6=ing_6/abr04 if meses=="090807060504"
replace ing_5=ing_5/may04 if meses=="090807060504"
replace ing_4=ing_4/jun04 if meses=="090807060504"
replace ing_3=ing_3/jul04 if meses=="090807060504"
replace ing_2=ing_2/ago04 if meses=="090807060504"
replace ing_1=ing_1/sep04 if meses=="090807060504"

replace ing_6=ing_6/may04 if meses=="100908070605"
replace ing_5=ing_5/jun04 if meses=="100908070605"
replace ing_4=ing_4/jul04 if meses=="100908070605"
replace ing_3=ing_3/ago04 if meses=="100908070605"
replace ing_2=ing_2/sep04 if meses=="100908070605"
replace ing_1=ing_1/oct04 if meses=="100908070605"
...
g double ypension = ing_mens  if  (clave=="P048" )                                     //Jubilaciones y pensiones originados dentro del país P048, No se incluyen lasprovenientes de otros países P049
...
replace clave = "XXXX" if clave == "0000"
...
rename folio folio1
gen str12 folio = subinstr(folio1," " ,"",.)

saveold "$ruta\ingreso_deflactado04_per.dta", replace
...
en la información de la ENIGH2004, se tomarán como periodos 
de referencia:
...
scalar d11w07	= 	0.9820427 	
scalar d11w08	= 	1.0000000 	
scalar d11w09	= 	1.0189132 	
scalar d11w10	= 	1.0392247 	
scalar d11w11	= 	1.0501018 	

*Rubro 1.2 semanal

scalar d12w07	= 	0.9967935 	
scalar d12w08	= 	1.0000000 	
scalar d12w09	= 	0.9965842 	
scalar d12w10	= 	0.9982112 	
scalar d12w11	= 	0.9968506 	

*Rubro 2 trimestral

scalar d2t05	= 	0.9958319 	
scalar d2t06	= 	0.9972376 	
scalar d2t07	= 	0.9987052 	
scalar d2t08	= 	1.0011545 	

*Rubro 3 mensual

scalar d3m07	= 	0.9961228 	
scalar d3m08	= 	1.0000000 	
scalar d3m09	= 	1.0040215 	
scalar d3m10	= 	1.0099726 	
scalar d3m11	= 	1.0301432 	

*Rubro 4.2 mensual

scalar d42m07	= 	0.9996413 	
scalar d42m08	= 	1.0000000 	
scalar d42m09	= 	1.0004882 	
scalar d42m10	= 	1.0092163 	
scalar d42m11	= 	1.0158022 	

*Rubro 4.2 trimestral

scalar d42t05	= 	0.9992129 	
scalar d42t06	= 	0.9993690 	
scalar d42t07	= 	1.0000432 	
scalar d42t08	= 	1.0032348 	

*Rubro 4.1 semestral

scalar d41s02	= 	0.9982854 	
scalar d41s03	= 	0.9987375 	
scalar d41s04	= 	0.9993821 	
scalar d41s05	= 	1.0001172 	

*Rubro 5.1 trimestral

scalar d51t05	= 	0.9963375 	
scalar d51t06	= 	0.9982059 	
scalar d51t07	= 	1.0002797 	
scalar d51t08	= 	1.0021124 	

*Rubro 6.1.1 semanal

scalar d611w07	= 	0.9988292 	
scalar d611w08	= 	1.0000000 	
scalar d611w09	= 	1.0012506 	
scalar d611w10	= 	1.0037164 	
scalar d611w11	= 	1.0057121 	

*Rubro 6 mensual

scalar d6m07	= 	0.9982541 	
scalar d6m08	= 	1.0000000 	
scalar d6m09	= 	1.0019046 	
scalar d6m10	= 	1.0052658 	
scalar d6m11	= 	1.0077493 	

*Rubro 6 semestral

scalar d6s02	= 	0.9914151 	
scalar d6s03	= 	0.9950143 	
scalar d6s04	= 	0.9979366 	
scalar d6s05	= 	1.0001587 	

*Rubro 7 mensual

scalar d7m07	= 	0.9958574 	
scalar d7m08	= 	1.0000000 	
scalar d7m09	= 	1.0216035 	
scalar d7m10	= 	1.0223615 	
scalar d7m11	= 	1.0229520 	

*Rubro 2.3 mensual

scalar d23m07	= 	0.9897551 	
scalar d23m08	= 	1.0000000 	
scalar d23m09	= 	1.0024341 	
scalar d23m10	= 	1.0078199 	
scalar d23m11	= 	1.0148405	

*Rubro 2.3 trimestral

scalar d23t05	= 	0.9846145 	
scalar d23t06	= 	0.9911447 	
scalar d23t07	= 	0.9973964 	
scalar d23t08	= 	1.0034180 	

*INPC semestral

scalar dINPCs02	= 	0.9908306 	
scalar dINPCs03	= 	0.9929426 	
scalar dINPCs04	= 	0.9958749 	
scalar dINPCs05	= 	0.9997220 	
...
saveold "$ruta\gastomonetario_def04.dta", replace
...
saveold "$ruta\gastonomonetario_def04.dta", replace
...
saveold "$ruta\auto_def04.dta", replace

use "$ruta\gastonomonetario_def04.dta", clear
...
saveold "$ruta\esp_def04.dta", replace
...
saveold "$ruta\reg_def04.dta", replace

*********************************************************

/*Parte IV

Cálculo de la incidencia 2004
...
/*
merge folio using "$ruta\ingreso_deflactado04.dta"
tab _merge
drop _merge
sort folio*/

merge 1:1  folio using "$ruta\gastomonetario_def04.dta"
tab _merge
drop _merge
sort folio

merge 1:1  folio using "$ruta\auto_def04.dta"
tab _merge
drop _merge
sort folio

merge 1:1  folio using "$ruta\esp_def04.dta"
tab _merge
drop _merge
sort folio

merge 1:1  folio using "$ruta\reg_def04.dta"
tab _merge
drop _merge
sort folio
...
saveold "$ruta\gtos_autoc04.dta", replace //Mayra Sáenz Julio 2015
...
use "$ruta\pobla04.dta", clear

sort folio num_ren, stable

merge 1:1 folio num_ren using "$ruta\ingreso_deflactado04_per.dta"
rename _merge _merge_ing
sort folio num_ren, stable

merge m:1 folio using "$ruta\gtos_autoc04.dta"
...
use "$ruta\hoga.dta",clear
gen n_vivi=substr(folio,11,1)
gen vivi=substr(folio,1,10)
keep vivi folio n_vivi estrato-eqv25_13
keep if  n_vivi=="0"
sort vivi folio
saveold "$ruta\vivi2004.dta",replace

use "$ruta\hoga.dta",clear
gen vivi=substr(folio,1,10)
keep vivi folio residentes-factor
sort vivi folio
saveold "$ruta\hoga2004.dta",replace

*merge de archivos*
merge vivi using "${surveysFolder}\ARM\MEX\ENIGH\2004\Orig_data\vivi2004.dta"
sort folio 
capture drop _merge
saveold "$ruta\MEX2004EA_BID.dta",replace

use "$ruta\poblacio.dta", clear
sort folio
merge folio using "$ruta\MEX2004EA_BID.dta"
drop _merge
sort folio num_ren
gen id=_n
saveold "$ruta\MEX2004EA_BID.dta",replace
...
merge folio num_ren using "$ruta\MEX2004EA_BID.dta"
sort id
drop if id==id[_n-1]
drop if _merge==1
drop _merge
