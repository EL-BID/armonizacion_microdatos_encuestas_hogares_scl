...
*************
* COL 2003
gen salmm_ci= 	11066.6666666667*22
...
*cesante_ci* 
*************
destring p53_T70 p53_T70, replace
gen cesante_ci=1 if p53_T70==2  | p53_T70 ==2
replace cesante_ci=0 if p53_T70==1 | p53_T70==1
...
replace promhora=. if p34_T61=="999" |  p34_T61=="998"

/*esta acotada
gen hora_no=real(p35_T612) if p35_T611=="1" & emp_ci==1 
replace hora_no=. if p35_T612=="999" | p35_T612=="998"
/*esta acotada*/
gen hora_ad=real(p36_T612) if p36_T611=="1" & emp_ci==1 
replace hora_ad=. if p36_T612=="999"  | p36_T612=="998"
...
*Y.L -> la categoria es diferent para cab y resto
...
***spublico_ci***
*****************
destring p27_T60res, replace
destring p27_T60cab, replace
