...
ren urbrur q02
ren ednumber q03
* ren sample q04 not available for 2004 *
ren hhnumber q05
ren week q06
ren result q07
*sort qid
...
gen idp_ci= personnu /*  personnu for 2004 */
...
*replace relacion_ci=3 if relate==3 | relate==1
*replace relacion_ci=4 if relate==4 | relate==5 | relate==6 | relate==7 | relate==2 | relate==3
*replace relacion_ci=5 if relate==8 | relate==4
*replace relacion_ci=. if relate==9 | relate==9 /* No sabe */

gen relacion_ci=.
replace relacion_ci=1 if relate==1
replace relacion_ci=2 if relate==2
replace relacion_ci=3 if relate==3 | relate==4
replace relacion_ci=4 if relate==5 | relate==6 | relate==7 
...
gen aguamala_ch=.
replace aguamala_ch=1 if water==8 /* river/ stream / creek / pond / spring */
replace aguamala_ch=0 if water!=8  
replace aguadist_ch=. if water==99 | water==9

gen aguamide_ch=.

/*
       h5 what is the main source of |
                           lighting? |      Freq.     Percent        Cum.
  -----------------------------------+-----------------------------------
1                           gas lamp |        257        1.29        1.29
2                      kerosene lamp |      1,613        8.12        9.41
3               electricity from bel |     17,197       86.53       95.94
4 electricity from pirvate generator |        441        2.22       98.16
5                              other |        346        1.74       99.90
...
/*
  ...
  -------------+-----------------------------------
1         wood |      4,058       20.42       20.42
2 gas (butane) |     15,375       77.36       97.78
3 kerosene oil |        165        0.83       98.61
4  electricity |        148        0.74       99.36
5        other |        104        0.52       99.88
9        dk/ns |         24        0.12      100.00
  -------------+-----------------------------------
         Total |     19,874      100.00
*/
...
/*
     h4 what type of toilet facility does |
                     this household have? |      Freq.     Percent        Cum.
  ----------------------------------------+-----------------------------------
1          w.c. lined to bws sewer system |      2,807       14.12       14.12
2              w.c. linked to septic tank |      7,635       38.42       52.54
3    pit latrine, ventilated and elevated |      2,530       12.73       65.27
4 pit latrine, ventilated and not elevate |      1,989       10.01       75.28
5         pit latrine, ventilated compost |        286        1.44       76.72
6             pit latrine, not ventilated |      4,007       20.16       96.88
7                                   other |        122        0.61       97.49
8                                    none |        432        2.17       99.67
9                                   dk/ns |         66        0.33      100.00
  ----------------------------------------+-----------------------------------
                                    Total |     19,874      100.00
*/
...
/*
   ...
   --------------------+-----------------------------------
1  own / hire purchase |     14,525       73.09       73.09
2                lease |        570        2.87       75.95
3       rent - private |      2,999       15.09       91.04
4    rent - government |        163        0.82       91.86
5          rent - free |      1,410        7.09       98.96
6                squat |        173        0.87       99.83
7                other |         14        0.07       99.90
9                dk/ns |         20        0.10      100.00
   --------------------+-----------------------------------
                 Total |     19,874      100.00
*/
