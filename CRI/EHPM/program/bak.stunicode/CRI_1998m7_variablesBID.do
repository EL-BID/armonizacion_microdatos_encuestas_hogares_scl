...
capture drop lp_ci
gen lp_ci = .
replace lp_ci =   20706 if zona_c==1
replace lp_ci =   16436 if zona_c==0
...
gen lpe_ci = .
replace lpe_ci =    9498 if zona_c==1
replace lpe_ci =    8343 if zona_c==0
...
* 1998 junio (fuente OIT-CEPAL observatorio de la crisis)
gen salmm_ci= 51584
