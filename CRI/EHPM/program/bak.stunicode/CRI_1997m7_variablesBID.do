...
capture drop lp_ci
gen lp_ci = .
replace lp_ci =    17599 if zona_c==1
replace lp_ci =    13812 if zona_c==0
...
gen lpe_ci = .
replace lpe_ci =     8073 if zona_c==1
replace lpe_ci =     7011 if zona_c==0
...
/*CorrecciÃ³n Alvaro Altamirano 06/13/2017. Se restringen tambiÃ©n pensiones con valor de 999999 (antes estaba solo para 99999999), 
porque producÃ­an valores atÃ­picos en la serie de pensiones contributivas para los years 1997 y 1998. */
replace aux_p=. if ypension==99999999 | ypension==999999
...
* 1997 junio (fuente OIT-CEPAL observatorio de la crisis)
gen salmm_ci= 45240
...
gen desalent_ci=(emp_ci==0 & (pqnobus==4 | pqnobus==5))
...
replace categopri_ci=4 if categp==6 
...
replace ocupa_ci=2 if ocupacpr>=100 & ocupacpr<=127 & emp_ci==1
...
replace rama_ci=2 if ramapr>=2200 & ramapr<=2909 & emp_ci==1
...
gen durades1_ci=1 if durinact==1 |  durinact==2
replace durades1_ci=2 if durinact==3
replace durades1_ci=3 if durinact>=4 & durinact<=5
replace durades1_ci=. if durinact==9
